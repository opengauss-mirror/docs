...
-   Check whether the system firewall is enabled.
    1.  Run the  **Euleros: systemctl status firewalld.service **command to view the openGauss firewall status.
    2.  If the system firewall is enabled, run  **Euleros: systemctl stop firewalld.service **to disable it.
