...
**Parameter description**: Specifies the GaussDB Kernel data directory. You can set this parameter using one of the following methods:

-   Set it when you install the GaussDB Kernel.
