...
1.  Download the installation package of the corresponding platform from the openGauss community.
    1.  Log in to the openGauss open source community at  [https://opengauss.org/en/download.html](https://opengauss.org/en/download.html), select  **2.1.0**  in the  **Version**  field, and download the corresponding  Simplified installation package.
