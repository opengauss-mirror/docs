# Text Search Types<a name="EN-US_TOPIC_0242370420"></a>
...
## tsvector<a name="en-us_topic_0237121956_en-us_topic_0059778491_sd7b46ba1616c4e2fac58b660666ca5ab"></a>
...
```
postgres=# SELECT 'a:1 fat:2 cat:3 sat:4 on:5 a:6 mat:7 and:8 ate:9 a:10 fat:11 rat:12'::tsvector;
                                   tsvector                                    
-------------------------------------------------------------------------------
...
## tsquery<a name="en-us_topic_0237121956_en-us_topic_0059778491_sc32b10b58f6242499a8461a993703975"></a>
...
```
postgres=# SELECT to_tsvector( 'postgraduate' ) @@ to_tsquery( 'postgres:*' ) AS RESULT;
  result  
----------
 t
(1 row)
