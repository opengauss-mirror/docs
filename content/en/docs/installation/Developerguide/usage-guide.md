# Usage Guide<a name="EN-US_TOPIC_0243595906"></a>

## Data Collection<a name="section5640724113415"></a>
...
2.  Disable data collection.
    1.  Set any of the following parameters related to the ActiveSQL operator.
...
## Model Management \(System Administrators\)<a name="section664217249345"></a>
...
1.  Add a new model.
    ...
    >![](public_sys-resources/icon-note.gif) **NOTE:**   
    >-   For details about model parameter settings, see  [GS\_OPT\_MODEL](gs_opt_model.md).  
...
## Model Training \(System Administrators\)<a name="section1221993514546"></a>

1.  Add models and modify model parameters by following the steps in  [Model Management \(System Administrators\)](#section664217249345).
...
## Other Functions<a name="section1492429198"></a>
