...
Performance issues may occur when you query data or run the  **INSERT**,  **DELETE**,  **UPDATE**, or  **CREATE TABLE AS**  statement. In this case, you can query the  **warning**  column in the  [GS\_WLM\_SESSION\_STATISTICS](gs_wlm_session_statistics.md),  [GS\_WLM\_SESSION\_HISTORY](gs_wlm_session_history.md), and  [GS\_WLM\_SESSION\_QUERY\_INFO\_ALL](gs_wlm_session_query_info_all.md)  views to obtain reference for performance optimization.
