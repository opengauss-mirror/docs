# Logging Destination<a name="EN-US_TOPIC_0242371511"></a>

## log\_destination<a name="en-us_topic_0237124721_en-us_topic_0059778787_sb6c9884f69bd4765a60f80810c94f194"></a>
...
-   **csvlog**  indicates that logs are output in comma separated value \(CSV\) format. The prerequisite for generating logs in CSV format is that  **[logging\_collector](#en-us_topic_0237124721_en-us_topic_0059778787_s61d6090c04ee464fb54f8b31936ba818)**  must be set to  **on**. For details, see  [Using CSV Log Output](using-csv-log-output.md).
-   **syslog**  indicates that logs are recorded using the syslog of the OS. openGauss can record logs using syslog from  **LOCAL0**  to  **LOCAL7**. For details, see  [syslog\_facility](#en-us_topic_0237124721_en-us_topic_0059778787_s853e14ac6a8a47678036cdc8e5119090). To record logs using syslog, add the following information to syslog daemon's configuration file:
...
## logging\_collector<a name="en-us_topic_0237124721_en-us_topic_0059778787_s61d6090c04ee464fb54f8b31936ba818"></a>
...
## log\_directory<a name="en-us_topic_0237124721_en-us_topic_0059778787_sfbedf09fcf1a4223a4538679f80f12a9"></a>
...
## log\_filename<a name="en-us_topic_0237124721_en-us_topic_0059778787_s3226ae3209154e249928c24ec67c5809"></a>
...
## log\_file\_mode<a name="en-us_topic_0237124721_en-us_topic_0059778787_s25e56fda28e1437b925cddfae168d607"></a>

**Parameter description**: Specifies the permissions of log files when  **[logging\_collector](#en-us_topic_0237124721_en-us_topic_0059778787_s61d6090c04ee464fb54f8b31936ba818)**  is set to  **on**. The parameter value is usually a number in the format acceptable to the  **chmod**  and  **umask**  system calls.
...
## log\_truncate\_on\_rotation<a name="en-us_topic_0237124721_en-us_topic_0059778787_s143b6d35ddbe48b8810106a4d3929e8a"></a>
...
## log\_rotation\_age<a name="en-us_topic_0237124721_en-us_topic_0059778787_s3ce09b8a7ae543b18fae13a821a725a5"></a>
...
## log\_rotation\_size<a name="en-us_topic_0237124721_en-us_topic_0059778787_s282e72143bb14915bedb4b432586b07e"></a>
...
## syslog\_facility<a name="en-us_topic_0237124721_en-us_topic_0059778787_s853e14ac6a8a47678036cdc8e5119090"></a>
...
## syslog\_ident<a name="en-us_topic_0237124721_en-us_topic_0059778787_sb24f217a6019495f96ca476232c71e18"></a>

**Parameter description**: Specifies the identifier of openGauss messages in syslog logs when  **[log\_destination](#en-us_topic_0237124721_en-us_topic_0059778787_sb6c9884f69bd4765a60f80810c94f194)**  is set to  **syslog**.
...
## event\_source<a name="en-us_topic_0237124721_en-us_topic_0059778787_s739c0331179f4669a2d6092219aa62de"></a>
