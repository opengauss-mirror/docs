...
-   Before the installation, provide the openGauss binary installation package and place it in the  **dockerfiles/<version\>**  folder and decompress the package. The binary package can be downloaded from  [https://opengauss.org/en/download.html](https://opengauss.org/en/download.html). Ensure that the correct yum source is available.      
