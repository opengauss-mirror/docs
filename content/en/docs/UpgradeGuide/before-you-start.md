...
Currently, in-place upgrade、gray upgrade and rolling upgrade are supported. The upgrade modes are classified into major version upgrade and minor version upgrade.
