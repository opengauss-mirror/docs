# Contribution<a name="EN-US_TOPIC_0254198549"></a>
...
You are welcome to join an existing SIG or create a SIG. For details about how to create a SIG, see  [Special Interest Group \(SIG\)](https://opengauss.org/en/contribution/).
...
openGauss has also opened an IRC channel as an additional channel to provide community support and interaction. For details, see  [openGauss IRC](https://opengauss.org/en/community/onlineCommunication/).
