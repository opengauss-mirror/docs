# DB4AI<a name="EN-US_TOPIC_0000001225655983"></a>
...
<tr id="row135154531653"><td class="cellrowborder" rowspan="3" valign="top" width="17.611761176117614%" headers="mcps1.2.4.1.1 "><p id="p3365997714"><a name="p3365997714"></a><a name="p3365997714"></a>Keywords</p>
</td>
...
1.  You can run the  **CREATE MODEL**  statement to create and train a model.
    ...
    Specify  **position**  as a feature column in the  **kmeans\_2d**  training set, and use the K-Means algorithm to create and save the  **point\_kmeans**  model.
    ...
    -   **WITH**  specifies the hyperparameters used for model training. When the hyperparameters are not set by the user, the framework uses the default value.
        ...
        **Table  2**  Hyperparameters supported by operators
        ...
        <p id="p1074918587561"><a name="p1074918587561"></a><a name="p1074918587561"></a>SVM limits the hyperparameter <strong id="b3264377195149"><a name="b3264377195149"></a><a name="b3264377195149"></a>lambda(double)</strong>.</p>
        </td>
        </tr>
        ...
        [Table 3](#table86881521502)  shows the default value and value range of each hyperparameter.
        ...
        **Table  3**  Default value and value range of each hyperparameter
        ...
        <td class="cellrowborder" valign="top" width="22.12%" headers="mcps1.2.5.1.3 "><p id="p1168918523011"><a name="p1168918523011"></a><a name="p1168918523011"></a><strong id="b20572706655149"><a name="b20572706655149"></a><a name="b20572706655149"></a>gd</strong> or <strong id="b7988984975149"><a name="b7988984975149"></a><a name="b7988984975149"></a>ngd</strong> (natural gradient descent)</p>
        </td>
        ...
        <td class="cellrowborder" valign="top" headers="mcps1.2.5.1.3 "><p id="p749216198198"><a name="p749216198198"></a><a name="p749216198198"></a>Number of samples per training</p>
        </td>
        </tr>
        ...
        <tr id="row155121949191717"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p10512249181710"><a name="p10512249181710"></a><a name="p10512249181710"></a>seed = 0 (random value of <strong id="b18846232215149"><a name="b18846232215149"></a><a name="b18846232215149"></a>seed</strong>)</p>
        </td>
        ...
        <td class="cellrowborder" valign="top" headers="mcps1.2.5.1.3 "><p id="p8493219141910"><a name="p8493219141910"></a><a name="p8493219141910"></a>Number of samples per training</p>
        </td>
        </tr>
