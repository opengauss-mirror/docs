# DBE\_SQL\_UTIL.drop\_sql\_patch<a name="EN-US_TOPIC_0000001266752046"></a>

drop\_sql\_patch is an interface function used to drop an SQL patch and return whether the execution is successful.

Only the initial, sysadmin, opradmin, and monadmin users have the permission to invoke this interface.

**Table 1** DBE\_SQL\_UTIL.drop\_sql\_patch input parameters and return values
...
<tr id="row261231671"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p8623313711"><a name="p8623313711"></a><a name="p8623313711"></a>result</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p962037711"><a name="p962037711"></a><a name="p962037711"></a>OUT bool</p>
</td>
