...
-   POSIX regular expressions
    ...
    **Table  1**  Regular expression match operators
    ...
    -   The  [**regexp\_replace\(string, p...**](character-processing-functions-and-operators.md#en-us_topic_0283137513_en-us_topic_0237121967_en-us_topic_0059779223_l3d209c16ba5f452798f2875e0144da4f)  function provides the functionality of replacing the substring matching the POSIX regular expression pattern with the new text.
