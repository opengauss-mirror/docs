...
-   **ENCRYPTED\_VALUE \(optional\)**
    ...
    >Chinese National Cryptography Standard \(Guomi\) constraints: SM2, SM3, and SM4 are Chinese national cryptography standards. To avoid legal risks, these algorithms must be used together. That is, if the CEK is used in the SM4\_SM3 algorithm, only the SM4 algorithm can be used to encrypt the CEK.
