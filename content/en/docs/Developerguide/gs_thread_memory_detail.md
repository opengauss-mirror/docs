# GS\_THREAD\_MEMORY\_DETAIL<a name="EN-US_TOPIC_0242386038"></a>

**GS\_THREAD\_MEMORY\_DETAIL**  displays statistics about memory usage of all threads based on MemoryContext nodes. This view is equivalent to the  **GS\_SESSION\_MEMORY\_DETAIL**  view when  **enable\_thread\_pool**  is set to  **off**.
