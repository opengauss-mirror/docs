...
>Certain vacuum operations hold critical locks and should be complete as quickly as possible. In GaussDB Kernel, cost-based vacuum delays do not take effect during such operations. To avoid uselessly long delays in such cases, the actual delay is the larger of the two calculated values:
