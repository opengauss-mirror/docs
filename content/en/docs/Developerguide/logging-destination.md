...
-   **csvlog**  indicates that logs are output in comma separated value \(CSV\) format. The prerequisite for generating logs in CSV format is that  **[logging\_collector](#en-us_topic_0283136719_en-us_topic_0237124721_en-us_topic_0059778787_s61d6090c04ee464fb54f8b31936ba818)**  must be set to  **on**. For details, see  [Using CSV Log Output](en-us_topic_0289900524.md).
