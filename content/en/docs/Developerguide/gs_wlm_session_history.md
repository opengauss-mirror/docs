...
**GS\_WLM\_SESSION\_HISTORY**  displays load management information about all completed jobs executed by the current user on database instances. Only the user with the  **sysadmin**  or  **monitor admin**  permission can query this view.
...
<td class="cellrowborder" valign="top" width="59.4059405940594%" headers="mcps1.2.4.1.3 "><p id="en-us_topic_0112535431_p11628410399"><a name="en-us_topic_0112535431_p11628410399"></a><a name="en-us_topic_0112535431_p11628410399"></a>IP address of the client connected to this backend. If this column is <strong id="b114883287818"><a name="b114883287818"></a><a name="b114883287818"></a>NULL</strong>, it indicates either the client is connected via a Unix socket on the server or this is an internal process, such as <strong id="b94941428181"><a name="b94941428181"></a><a name="b94941428181"></a>AUTOVACUUM</strong>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59.4059405940594%" headers="mcps1.2.4.1.3 "><p id="en-us_topic_0112535431_p86216411395"><a name="en-us_topic_0112535431_p86216411395"></a><a name="en-us_topic_0112535431_p86216411395"></a>TCP port number that the client uses for communication with this backend (<strong id="b16730400984314"><a name="b16730400984314"></a><a name="b16730400984314"></a>-1</strong> if a Unix socket is used).</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59.4059405940594%" headers="mcps1.2.4.1.3 "><p id="p4550152115450"><a name="p4550152115450"></a><a name="p4550152115450"></a>Logical <span id="text828991392810"><a name="text828991392810"></a><a name="text828991392810"></a>cluster</span> of the user running the statement.</p>
</td>
</tr>
