...
-   **DELTAMERGE**
    ...
    \(For column-store tables\) Migrates data from the delta table to primary tables. For a column-store table, this operation is controlled by  **deltarow\_threshold**. For details, see  [enable\_delta\_store](en-us_topic_0283136577.md#en-us_topic_0237124705_section1035224982816)  and  [Parameter Description](en-us_topic_0283137629.md#en-us_topic_0237122117_en-us_topic_0059778169_s99cf2ac11c79436c93385e4efd7c4428).
