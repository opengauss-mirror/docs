...
>-   If there are multiple archive commands, write them to the shell script file and set  **archive\_command **to the command for executing the script. For example:
>    ```
