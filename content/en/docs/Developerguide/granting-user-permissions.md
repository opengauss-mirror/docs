# Granting User Permissions<a name="EN-US_TOPIC_0257867378"></a>
...
>The granting of user permissions is required because MOT is integrated into the openGauss database by using and extending the Foreign Data Wrapper \(FDW\) mechanism.  
