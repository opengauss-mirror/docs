# User Guide<a name="EN-US_TOPIC_0300593884"></a>
...
For details about algorithms in the library and how to use them, see the  [official MADlib document](http://madlib.apache.org/docs/3.0.0/index.html).
