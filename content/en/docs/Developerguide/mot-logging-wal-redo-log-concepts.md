...
-   **Synchronous Redo Logging**
    ...
    **Figure  1**  Synchronous Logging<a name="fig7699173313487"></a>  
    <img src="figures/synchronous-logging.png" title="synchronous-logging" style="zoom:50%;" />
...
- **Group Synchronous Redo Logging**
  ...
  **Figure  2**  Group Commit – with NUMA-awareness<a name="fig15692104135510"></a>  
  <img src="figures/group-commit-with-numa-awareness.png" title="group-commit-with-numa-awareness" style="zoom:50%;" />
...
-   **Asynchronous Redo Logging**
    ...
    **Figure  3**  Asynchronous Logging<a name="fig146428327119"></a>  
    <img src="figures/asynchronous-logging.png" title="asynchronous-logging" style="zoom:50%;" />
    ...
    **Figure  4**  Three Logging Options<a name="fig519319561310"></a>  
    <img src="figures/three-logging-options.png" title="three-logging-options" style="zoom:50%;" />
