# cursor.execute\(query,vars\_list\)<a name="EN-US_TOPIC_0000001126928997"></a>
...
## Parameters<a name="en-us_topic_0237120432_en-us_topic_0059778852_s1c9b27937d964eaba00ae77fe1cd2c71"></a>
...
<td class="cellrowborder" valign="top" width="76.72%" headers="mcps1.2.3.1.2 "><p id="p1393801515211"><a name="p1393801515211"></a><a name="p1393801515211"></a>SQL statement to be executed.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="76.72%" headers="mcps1.2.3.1.2 "><p id="p1011981671716"><a name="p1011981671716"></a><a name="p1011981671716"></a>Variable list, which matches the <strong id="b176611656205610"><a name="b176611656205610"></a><a name="b176611656205610"></a>%s</strong> placeholder in the query.</p>
</td>
</tr>
</tbody>
</table>
