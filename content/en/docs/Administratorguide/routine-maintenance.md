...
1.  Log in as the OS user  **omm**  to any host in the GaussDB Kernel cluster.
2.  Create a configuration file for recording each cluster node. \(You can specify the  _mpphosts_  file directory randomly. It is recommended that the file be stored in the  **/tmp**  directory.\)
