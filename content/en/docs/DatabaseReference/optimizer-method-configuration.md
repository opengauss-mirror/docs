...
**Parameter description**: Specifies the query optimizer's use of memoize.In some situation,it can optimize the parametrized nestloop.  [example](memoize_example.md)
