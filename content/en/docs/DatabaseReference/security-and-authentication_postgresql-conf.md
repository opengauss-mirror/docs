...
**Parameter description**: Specifies whether SSL connections are enabled. Read  [Using gsql to Connect to a Database](../DatabaseAdministrationGuide/using-gsql-to-operate-an-encrypted-database.md)  before setting this parameter.
