...
>
>如果使用om安装或其他需要使用xml设置集群信息的安装方式，该参数的值依赖xml文件里的dataNode1_syncNum或syncNode_hostname字段的值，不在xml设置该字段时synchronous_commit默认为off，具体请参考[创建XML配置文件](../InstallationGuide/创建XML配置文件.md)
