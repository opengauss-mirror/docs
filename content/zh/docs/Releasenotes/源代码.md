...
openGauss主要包含18个代码仓，引用开源软件的补丁代码仓、JDBC驱动代码仓、ODBC驱动代码仓、数据库服务器代码仓、自治运维平台DBMind代码仓、数据库OM管理工具、数据库CM管理工具代码仓、数据库DMS代码仓、数据库DSS代码仓、数据库DCF代码仓、数据库DCC代码仓、数据库插件代码仓、MySQL到openGauss全量迁移工具代码仓、MySQL增量迁移代码仓、数据校验代码仓、数据库prometheus-exporter代码仓、监控插件生成工具代码仓和文档仓库：
...
-   MySQL增量迁移工具代码仓（包含反向迁移）：[https://gitee.com/opengauss/openGauss-tools-onlineMigration-mysql](https://gitee.com/opengauss/openGauss-tools-onlineMigration-mysql)
