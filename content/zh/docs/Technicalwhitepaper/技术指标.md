...
<td class="cellrowborder" valign="top" width="54.55%" headers="mcps1.1.3.1.2 "><p id="zh-cn_concept_0283138979_zh-cn_topic_0237080616_zh-cn_topic_0231764304_p82678311136"><a name="zh-cn_concept_0283138979_zh-cn_topic_0237080616_zh-cn_topic_0231764304_p82678311136"></a><a name="zh-cn_concept_0283138979_zh-cn_topic_0237080616_zh-cn_topic_0231764304_p82678311136"></a>最大为2<sup> 32 </sup> * (（8k - 页面头）/行宽)。代码层面的限制是单表最多232个页面，每个页面大小为8k。假设当前数据行宽是1k（包括tuple头），则单表记录数约为7 * 2<sup> 32 </sup> 行（当前页面大小是8k，除了页面头，每个页面包含7行数据）。 </p>
</td>
</tr>
