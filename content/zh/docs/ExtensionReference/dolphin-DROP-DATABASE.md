...
相比于原始的openGauss，dolphin对于DROP DATABASE语法的修改为：

- 增加DATABASE解析为SCHEMA含义。
...
请参见CREATE DATABASE的[示例](dolphin-CREATE-DATABASE.md#zh-cn_topic_0283137050_zh-cn_topic_0237122099_zh-cn_topic_0059778277_s6be7b8abbb4b4aceb9dae686434d672c)。
