...
opengauss=# CREATE ROLE test_proxy_u1 IDENTIFIED BY 'xxxxxx';
opengauss=# DROP ROLE if EXISTS test_proxy_u2;
opengauss=# CREATE ROLE test_proxy_u3 IDENTIFIED BY 'xxxxxx';
...
opengauss=# SET ROLE test_proxy_u2 PASSWORD 'xxxxx';
opengauss=> grant proxy on test_proxy_u1 to test_proxy_u3;
