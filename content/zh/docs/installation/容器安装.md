...
-   安装前需要提供openGauss二进制安装包，解压后将以bz2结尾的包（openGauss-X.X.X-CentOS-64bit.tar.bz2）放到 dockerfiles/<version\>文件夹。二进制包可以从  [https://opengauss.org/zh/download/](https://opengauss.org/zh/download/)下载，确保有正确的yum源。
