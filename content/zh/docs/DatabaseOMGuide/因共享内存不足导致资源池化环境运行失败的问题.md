...
-------------------------------------------------------------------------------------
1  openGauss169 172.168.90.169  1    /data/ctt_ltt/omm/openGauss/cm/cm_server Standby
2  openGauss171 172.168.90.171  2    /data/ctt_ltt/omm/openGauss/cm/cm_server Primary
...
----------------------------------------------------------
1  openGauss169 172.168.90.169  dms_res  6001      Deleted
2  openGauss171 172.168.90.171  dms_res  6002      OnLine
1  openGauss169 172.168.90.169  dss      20001     Deleted
2  openGauss171 172.168.90.171  dss      20002     OnLine
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
1  openGauss169 172.168.90.169  6001 3500   /data/ctt_ltt/omm/openGauss/dn1 P Down    Manually stopped | 2  openGauss171 172.168.90.171  6002 3500   /data/ctt_ltt/omm/openGauss/dn1 S Standby Promoting
```
...
node            node_ip         instance                                    state            | node            node_ip         instance                                    state
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
1  openGauss169 172.168.90.169  6001 3500   /data/ctt_ltt/omm/openGauss/dn1 P Down    Manually stopped | 2  openGauss171 172.168.90.171  6002 3500   /data/ctt_ltt/omm/openGauss/dn1 S Primary Normal
```

## 二、定位方法
检查故障节点pg_log日志，检查到如下错误打印：
...
## 四、解决方案
数据库运行环境上，应当避免清理共享内存，同时对于RemoveIPC参数也应当设置为false。
