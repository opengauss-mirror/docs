...
-   gsql: FATAL:  sorry, too many clients already，active/non-active: 197/3.
    ...
    **表 1**  查看会话连接数
    ...
    <td class="cellrowborder" valign="top" width="68.58999999999999%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"><a name="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"></a><a name="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"></a>执行如下命令查看连接到指定数据库postgres的会话连接数上限。其中，-1表示没有对数据库postgres设置连接数的限制。</p>
    ...
    <td class="cellrowborder" valign="top" width="68.58999999999999%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"><a name="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"></a><a name="zh-cn_topic_0237152147_zh-cn_topic_0059779356_ad60bdc8421564f9185293df24f420bb1"></a>执行如下命令查看指定数据库postgres已使用的会话连接数。其中，1表示数据库postgres已使用的绘画连接数。</p>
