...
<a name="ul0976124733118"></a><a name="ul0976124733118"></a><ul id="ul0976124733118"><li>节点名称必须为小写字母（a-z）、下划线（_）、ASCII码（\u200-\u377）、特殊符号#、数字（0-9）或美元符号（$）。</li><li>节点名称必须以小写字母（a-z）、ASCII码（\u200-\u377）或下划线（_）开头。</li></ul>
</td>
</tr>
