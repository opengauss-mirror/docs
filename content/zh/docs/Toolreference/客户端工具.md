# 客户端工具<a name="ZH-CN_TOPIC_0249632297"></a>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0237152145_zh-cn_topic_0059779319_aefbd427a18574418b2cdf13b05433b9c"><a name="zh-cn_topic_0237152145_zh-cn_topic_0059779319_aefbd427a18574418b2cdf13b05433b9c"></a><a name="zh-cn_topic_0237152145_zh-cn_topic_0059779319_aefbd427a18574418b2cdf13b05433b9c"></a>默认为<span id="text47021142550"><a name="text47021142550"></a><a name="text47021142550"></a>15400</span>。</p>
</td>
</tr>
...
-   <u>gsql: FATAL:  permission denied for database "postgres"</u>
    ...
    <u>此问题是由于用户不具备访问该数据库的权限，可以使用如下方法解决。</u>

    1.  <u>使用管理员用户dbadmin连接数据库。</u>
    ...
    2.  <u>赋予该用户访问数据库的权限。</u>
        ...
        >![](public_sys-resources/icon-note.gif) **说明：** 
        ><u>实际上，常见的许多错误操作也可能产生用户无法连接上数据库的现象。如用户连接的数据库不存在，用户名或密码输入错误等。这些错误操作在客户端工具也有相应的提示信息。</u>
        >```
        >gsql -d postgres -p 15400
...
-   gsql: FATAL:  sorry, too many clients already，active/non-active: 197/3.
    ...
    此问题是由于系统连接数量超过了[表 查看会话连接数](#zh-cn_topic_0237152147_zh-cn_topic_0059779356_t8e166846f0204638bd83f2fd35f44585)最大连接数量。请联系数据库DBA进行会话连接数管理，释放无用会话。
