# 使用指导<a name="ZH-CN_TOPIC_0242223660"></a>

## 前提条件<a name="zh-cn_topic_0237152143_zh-cn_topic_0059779027_s7c2e433674384463a42b1e562a499257"></a>

连接数据库时使用的用户需要具备访问数据库的权限。

## 背景信息<a name="zh-cn_topic_0237152143_zh-cn_topic_0059779027_sec8c9233ebad4d6da06846cb31af1f44"></a>

使用gsql命令可以连接本机的数据库服务，也可以连接远程数据库服务。连接远程数据库服务时，需要在服务器上设置允许远程连接，详细操作请参见《开发者指南》中“数据库使用 \> 连接数据库 \> 使用gsql连接 \> 远程连接数据库”章节。

## 操作步骤<a name="zh-cn_topic_0237152143_zh-cn_topic_0059779027_s88b93467806944068b85cf2ec928ae02"></a>
...
## 示例<a name="zh-cn_topic_0237152143_zh-cn_topic_0059779027_sa12a135ee93d4bfa8fcbf57ae87b805d"></a>
