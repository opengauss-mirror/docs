# 工具一览表<a name="ZH-CN_TOPIC_0289899254"></a>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p111121267180"><a name="p111121267180"></a><a name="p111121267180"></a>gs_loader工具用于进行数据导入。gs_loader将控制文件支持的语法转换为\COPY语法，然后利用已有的\COPY功能，做主要数据导入工作，同时gs_loader将\COPY结果记录到日志中。</p>
</td>
</tr>
