...
- CM支持的DN仲裁模式主要分为：
  ...
  - 共享存储模式：
    ...
    - 介绍和约束：参考[共享存储](https://gitcode.com/opengauss/docs/blob/5b0ab0d649009a536dd771fa15ea2f3130163510/content/zh/docs/Toolreference/特性介绍.md#section135462412052)
