...
**取值范围**： 字符串，格式同(90,90,90,0,0)。修改后可以reload生效。参数修改请参考[表 set cm参数](cm_ctl工具介绍.md#table10437204416514)进行设置。
...
**取值范围**： 整型，\[0, 100\]。修改后可以reload生效，参数修改请参考[表 set cm参数](cm_ctl工具介绍.md#table10437204416514)进行设置。
...
**取值范围**： 整型，\[0, 2147483647\]，单位：毫秒。修改后可以reload生效。参数修改请参考[表 set cm参数](cm_ctl工具介绍.md#table10437204416514)进行设置。
