# 性能统计<a name="ZH-CN_TOPIC_0251900957"></a>

在数据库运行过程中，会涉及到锁的访问、磁盘IO操作、无效消息的处理，这些操作都可能是数据库的性能瓶颈，通过openGauss提供的性能统计方法，可以方便定位性能问题。

## 输出性能统计日志<a name="zh-cn_topic_0242371518_zh-cn_topic_0237124728_zh-cn_topic_0059778587_se1e8361c204243558d92573aac3fdb1a"></a>
