...
openGauss=# CREATE ROLE miriam WITH LOGIN PASSWORD 'Bigdata@123' VALID BEGIN '2015-01-01' VALID UNTIL '2026-01-01';
...
--下面语句与上面的等价。
openGauss=# CREATE USER kim IDENTIFIED BY 'Bigdata@123';
