...
目前openGauss配置文件“pg\_hba.conf”中的参数默认值都是单机的配置模式。应用程序可以通过调用gs\_guc来设置适合自己的参数。更多配置请参见[开发者指南](https://opengauss.org/zh/docs/1.0.0/docs/Developerguide/Developerguide.html)。
