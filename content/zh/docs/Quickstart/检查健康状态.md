# 检查健康状态<a name="ZH-CN_TOPIC_0270171712"></a>

通过openGauss提供的gs\_checkos工具可以完成操作系统状态检查。

## 前提条件<a name="zh-cn_topic_0249784575_zh-cn_topic_0085434669_section574475764117"></a>

-   当前的硬件和网络环境正常。
-   各主机间root互信状态正常。
-   只能使用root用户执行gs\_checkos命令。

## 操作步骤<a name="zh-cn_topic_0249784575_section54111653133815"></a>
...
## 示例<a name="zh-cn_topic_0249784575_zh-cn_topic_0085434669_zh-cn_topic_0069042386_zh-cn_topic_0059777853_sb6d3ac772495414da1fb16238a23ceb5"></a>
