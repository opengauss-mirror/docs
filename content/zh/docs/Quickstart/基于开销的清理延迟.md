# 基于开销的清理延迟<a name="ZH-CN_TOPIC_0251900930"></a>
...
## 背景信息<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_zh-cn_topic_0059778692_s07d4dedef9d24a83acb5d9412d6b68fc"></a>

在ANALYZE和VACUUM语句执行过程中，系统维护一个内部的记数器，跟踪所执行的各种I/O操作的近似开销。如果积累的开销达到了vacuum\_cost\_limit声明的限制，则执行这个操作的进程将睡眠vacuum\_cost\_delay指定的时间。然后它会重置记数器然后继续执行。

这个特性是缺省关闭的。要想打开它，把vacuum\_cost\_delay变量设置为一个非零值。

## vacuum\_cost\_delay<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_section117926911015"></a>
...
## vacuum\_cost\_page\_hit<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_section1288159151015"></a>
...
## vacuum\_cost\_page\_miss<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_section165681910191413"></a>
...
## vacuum\_cost\_page\_dirty<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_section412883521410"></a>
...
## vacuum\_cost\_limit<a name="zh-cn_topic_0242371492_zh-cn_topic_0237124702_section1557591091412"></a>
