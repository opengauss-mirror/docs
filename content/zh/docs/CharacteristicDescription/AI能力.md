# AI能力<a name="ZH-CN_TOPIC_0000001105235306"></a>
...
AI与数据库结合是近些年的行业研究热点，openGauss较早地参与了该领域的探索，并取得了阶段性的成果。AI特性子模块名为DBMind，相对数据库其他功能更为独立，大致可分为AI4DB、DB4AI、AI in DB和ABO优化器四个部分。
