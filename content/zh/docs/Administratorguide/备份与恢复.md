...
- **恢复目标相关参数\(recovery\_options\)**
  ...
  >![](C:/Users/lijun/Downloads/管理员、工具、安装、编译-中英文/管理员、工具、安装、编译-中英文/04 管理员指南/public_sys-resources/icon-note.gif) **说明：** 
...
-   recyclebin\_retention_time参数用于设置回收站对象保留时间，超过该时间的回收站对象将被自动清理。
