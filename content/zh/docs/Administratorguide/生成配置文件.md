# 生成配置文件<a name="ZH-CN_TOPIC_0242215051"></a>
...
2.  执行如下命令会在本服务器指定目录下生成配置文件。
    ...
    2.  若不使用--distribute参数，需执行[3](#zh-cn_topic_0237088792_zh-cn_topic_0059777801_lc1ce55d572e44beea3e47b1b427fae3e)将静态配置文件分配到对应节点；若使用--distribute参数，则会将生成的静态配置文件自动分配到对应节点，无需执行步骤[3](#zh-cn_topic_0237088792_zh-cn_topic_0059777801_lc1ce55d572e44beea3e47b1b427fae3e)。
