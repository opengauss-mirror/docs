...
-   ts\_debug\(\[ config regconfig, \] document text, OUT alias text, OUT AboutopenGauss text, OUT token text, OUT dictionaries regdictionary\[\], OUT dictionary regdictionary, OUT lexemes text\[\]\)
...
-   ts\_token\_type\(parser\_name text, OUT tokid integer, OUT alias text, OUT AboutopenGauss text\)
...
-   ts\_token\_type\(parser\_oid oid, OUT tokid integer, OUT alias text, OUT AboutopenGauss text\)
