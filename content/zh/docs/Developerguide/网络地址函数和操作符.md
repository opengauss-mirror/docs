# 网络地址函数和操作符<a name="ZH-CN_TOPIC_0242370439"></a>

## cidr和inet操作符<a name="zh-cn_topic_0237121975_zh-cn_topic_0059778594_s71ca011b21f64c9891528dc0883de0d3"></a>
...
## cidr和inet函数<a name="zh-cn_topic_0237121975_zh-cn_topic_0059778594_s32e5e4347b124a09b39c9ddb92c7618d"></a>
...
-   abbrev\(inet\)
    ...
    ```
    openGauss=# SELECT abbrev(inet '10.1.0.1/16') AS RESULT;
       result    
    -------------
     10.1.0.1/16
    (1 row)
...
-   abbrev\(cidr\)
    ...
    ```
    openGauss=# SELECT abbrev(cidr '10.1.0.1/16') AS RESULT;
     result  
    ---------
     10.1/16
    (1 row)
...
-   family\(inet\)
    ...
    ```
    openGauss=# SELECT family('::1') AS RESULT;
     result 
    --------
          6
    (1 row)
...
## macaddr函数<a name="zh-cn_topic_0237121975_zh-cn_topic_0059778594_s0395a90cd97040cbbcd45e59a111a122"></a>
