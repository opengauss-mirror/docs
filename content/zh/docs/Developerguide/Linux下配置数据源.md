# Linux下配置数据源<a name="ZH-CN_TOPIC_0244721235"></a>
...
3.  替换客户端openGauss驱动程序。
    1.  将openGauss-1.0.0-ODBC.tar.gz解压到“/usr/local/lib”目录下。解压会得到“psqlodbcw.la”和“psqlodbcw.so”两个文件。
    2.  将openGauss-1.0.0-ODBC.tar.gz解压后lib目录中的库拷贝到“/usr/local/lib”目录下。
