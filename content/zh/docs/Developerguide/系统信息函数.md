...
-   global\_clean\_prepared\_xacts\(text, text\)
    ...
    内部事务ID类型（xid）是64位，每40亿事务一次循环。这些函数使用的数据类型txid\_snapshot，存储在特定时刻事务ID可见性的信息。其组件描述在[表11](#zh-cn_topic_0283136950_zh-cn_topic_0237121987_zh-cn_topic_0059777618_t537e765e3f164cdeb9ca75f865e3aa0d)。
