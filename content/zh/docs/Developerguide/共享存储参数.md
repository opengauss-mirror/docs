...
**取值范围：**整型，0~887。
>>>>>>> 5e799ff9c0ddde3b98e323708070b4713b44b4cb

**默认值：** 7

>![](public_sys-resources/icon-note.gif) **说明：** 
>-   高并发场景下，如果配置debug日志，其他参数默认的情况下，会出现消息线程频繁打日志，CM显示备机节点的状态不是normal的情况，尽管此时集群正常。因为在共享存储环境下，备机节点的CM获取节点状态也会走消息请求。
...
**参数说明：** 是否开启DSS异步IO功能，用于提升共享存储下脏页落盘的速度。
