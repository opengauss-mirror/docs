...
-   comm\_check\_connection\_status
    ...
    描述：返回该DN和其他所有活跃节点的连接情况。

    参数：nan

    返回值类型：node\_name text, remote\_name text, remote\_host text, remote\_port integer, is\_connected boolean
