...
**参数说明：**它存储的是透明加密的一个样本串，使用数据库加密密钥加密固定串“TRANS\_ENCRYPT\_SAMPLE\_STRING”后的密文，用来校验二次启动时获取的DEK是否正确。如果校验失败，那么数据库节点将拒绝启动。该参数属于POSTMASTER类型参数，请参考[表1](zh-cn_topic_0289899927.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
...
<td class="cellrowborder" valign="top" width="75.57000000000001%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0283137574_zh-cn_topic_0237124754_p15359171062012"><a name="zh-cn_topic_0283137574_zh-cn_topic_0237124754_p15359171062012"></a><a name="zh-cn_topic_0283137574_zh-cn_topic_0237124754_p15359171062012"></a>控制在使用MERGE INTO ... WHEN MATCHED THEN UPDATE（参考<a href="zh-cn_topic_0289900297.md">MERGE INTO</a>） 和INSERT ... ON DUPLICATE KEY UPDATE（参考<a href="zh-cn_topic_0289900448.md">INSERT</a>）时，当目标表中一条目标数据与多条源数据冲突时UPDATE行为。</p>
...
## bgwriter\_thread\_num<a name="zh-cn_topic_0283137574_section1227710331887"></a>
...
## candidate\_buf\_percent\_target<a name="zh-cn_topic_0283137574_section1590894110187"></a>
...
**取值范围**：双精度浮点型，0.1～0.85

**默认值**：0.3

## pagewriter\_thread\_num<a name="zh-cn_topic_0283137574_zh-cn_topic_0237124754_section20255113713185"></a>
...
## dirty\_page\_percent\_max<a name="zh-cn_topic_0283137574_section1413763444211"></a>
...
## pagewriter\_sleep<a name="zh-cn_topic_0283137574_zh-cn_topic_0237124754_section13857153472215"></a>
