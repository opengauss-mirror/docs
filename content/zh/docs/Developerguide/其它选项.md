...
<td class="cellrowborder" valign="top" width="75.57000000000001%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0237124754_p15521954134717"><a name="zh-cn_topic_0237124754_p15521954134717"></a><a name="zh-cn_topic_0237124754_p15521954134717"></a>控制函数concat()和concat_ws()对variadic类型结果兼容性的配置项。</p><p id="zh-cn_topic_0237124754_p1060812139425"><a name="zh-cn_topic_0237124754_p1060812139425"></a><a name="zh-cn_topic_0237124754_p1060812139425"></a>若设置此配置项，当concat函数参数为variadic类型时，保留a db和Teradata兼容模式下不同的结果形式；否则默认a db和Teradata兼容模式下结果相同，且与a db保持一致。由于MY无variadic类型，所以该选项对MY无影响。</p></td>
</tr>
