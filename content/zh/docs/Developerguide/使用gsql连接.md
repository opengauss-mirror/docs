...
## 密态数据库连接操作<a name="section2959172164218"></a>
...
2.  连接数据库。
    ...
    -C表示密态数据库开启，可以创建密钥和加密表。其它参数请参见[本地连接数据库](#zh-cn_topic_0283137029_zh-cn_topic_0237120292_zh-cn_topic_0062050379_sedb32189b5a4410a9a8ac8586f1766a0)。
