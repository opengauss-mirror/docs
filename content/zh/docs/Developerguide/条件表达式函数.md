# 条件表达式函数<a name="ZH-CN_TOPIC_0242370450"></a>

## 条件表达式函数<a name="zh-cn_topic_0237121986_zh-cn_topic_0059778809_s67706c61c09047c4bca384689f7f5c08"></a>
...
-   sys\_context\( 'namespace' , 'parameter'\)
    ...
    备注：目前仅支持SYS\_CONTEXT\('USERENV', 'CURRENT\_SCHEMA'\) 和SYS\_CONTEXT\('USERENV', 'CURRENT\_USER'\)两种格式。
