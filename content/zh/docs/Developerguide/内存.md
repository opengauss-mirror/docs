# 内存<a name="ZH-CN_TOPIC_0245374522"></a>
...
2.  若“cache”占用过高，请执行如下命令开启自动清除缓存功能。
    ...
    ```
    其中，openGauss-server为仓库代码，下载地址:[https://gitee.com/opengauss/openGauss-server.git](https://gitee.com/opengauss/openGauss-server.git)
