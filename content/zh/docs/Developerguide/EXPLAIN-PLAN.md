# EXPLAIN PLAN<a name="ZH-CN_TOPIC_0242370628"></a>

## 功能描述<a name="zh-cn_topic_0237122164_section0601642305"></a>

通过EXPLAIN PLAN命令可以将查询执行的计划信息存储于PLAN\_TABLE表中。与EXPLAIN命令不同的是，EXPLAIN PLAN仅将计划信息进行存储，而不会打印到屏幕。

## 语法格式<a name="zh-cn_topic_0237122164_zh-cn_topic_0165816825_section1531318315427"></a>
...
## 参数说明<a name="zh-cn_topic_0237122164_zh-cn_topic_0165816825_section12263165913464"></a>
...
## 注意事项<a name="zh-cn_topic_0237122164_zh-cn_topic_0165816825_section74641935135611"></a>

-   EXPLAIN PLAN不支持在数据库节点上执行。
-   对于执行错误的SQL无法进行计划信息的收集。
-   PLAN\_TABLE中的数据是session级生命周期并且session隔离和用户隔离，用户只能看到当前session、当前用户的数据。

## 示例 1<a name="zh-cn_topic_0237122164_zh-cn_topic_0165816825_section1128872085512"></a>
