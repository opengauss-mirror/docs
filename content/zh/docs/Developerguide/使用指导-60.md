...
1.  部署openGauss-exporter：启动openGauss-exporter，采用默认监听端口号9187，监听地址为192.168.1.100，不采用https协议，则命令可以为：
...
2.  部署reprocessing-exporter：启动reprocessing-exporter，采用默认监听端口号8181，监听地址为192.168.1.101，Prometheus-server IP与端口号为192.168.1.100:9090，采用https协议，则命令可以为：
