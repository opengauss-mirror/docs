...
-   账本数据库归档功能目前提供两种校验接口，分别为：[ledger\_hist\_archive\(text...](zh-cn_topic_0000001147093197.md#li18806468138)和[ledger\_gchain\_archive\(vo...](zh-cn_topic_0000001147093197.md#li988064691317)。账本数据库接口仅审计管理员可以调用。
