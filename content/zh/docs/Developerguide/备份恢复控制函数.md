# 备份恢复控制函数<a name="ZH-CN_TOPIC_0242370456"></a>

## 备份控制函数<a name="zh-cn_topic_0237121992_zh-cn_topic_0059778344_s540f3b3ffcd845909fe45a65f5cff84f"></a>
...
-   pg\_enable\_delay\_xlog\_recycle\(\)
    ...
    描述：开启延迟xlog回收功能，cn修复使用。

    返回值类型：void

-   pg\_disable\_delay\_xlog\_recycle\(\)

    描述：关闭延迟xlog回收功能，cn修复使用。

    返回值类型：void

-   gs\_roach\_enable\_delay\_xlog\_recycle\(is\_full\_backup boolean, backup\_key  text\)

    描述：开启延迟xlog回收功能，roach备份使用。

    返回值类型：void

-   gs\_roach\_disable\_delay\_xlog\_recycle\(is\_full\_backup boolean, backup\_key  text\)

    描述：关闭延迟xlog回收功能，roach备份使用。

    返回值类型：void


## 恢复控制函数<a name="zh-cn_topic_0237121992_zh-cn_topic_0059778344_sc7012e6115754c129c650cb2a0f899c9"></a>
