# 数组函数和操作符<a name="ZH-CN_TOPIC_0242370444"></a>

## 数组操作符<a name="zh-cn_topic_0237121980_zh-cn_topic_0059777596_s7fe6ac87a6fc4d7c8c7bd46484b9d9c3"></a>
...
## 数组函数<a name="zh-cn_topic_0237121980_zh-cn_topic_0059777596_sba9d38cb89864afaac99972eff9a8b00"></a>
...
-   array\_replace\(anyarray, anyelement, anyelement\)
    ...
    ```
    openGauss=# SELECT array_replace(ARRAY[1,8,3,7], 3, 9) AS RESULT;
     result 
    --------
     {1,8,9,7}
    (1 row)
