...
<td class="cellrowborder" valign="top" width="80.33%" headers="mcps1.2.3.1.2 "><p id="p829117463"><a name="p829117463"></a><a name="p829117463"></a>具有加解锁用户的权限，但不能加解锁初始用户和PERSISTENCE用户。</p>
 ...
 <tr id="row132201154612"><td class="cellrowborder" valign="top" width="19.67%" headers="mcps1.2.3.1.1 "><p id="p12141118462"><a name="p12141118462"></a><a name="p12141118462"></a>gs_role_pldebugger</p>
</td>
<td class="cellrowborder" valign="top" width="80.33%" headers="mcps1.2.3.1.2 "><p id="p829117463"><a name="p829117463"></a><a name="p829117463"></a>具有执行dbe_pldebugger下调试函数的权限。</p>
</td>
</tr>
</tbody>
</table>
