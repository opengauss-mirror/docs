...
3.  使用MERGE INTO 语句将源表products的数据合并至目标表newproducts。
    ...
    上述语句中使用的参数说明，请见[表1](#zh-cn_topic_0237121140_zh-cn_topic_0165787112_table1973914406416)。更多信息，请参见[MERGE INTO](MERGE-INTO.md#ZH-CN_TOPIC_0242370634)。
    ...
    **表 1**  MERGE INTO语句参数说明
    ...
    <a name="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"></a><a name="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"></a><ul id="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"><li>目标表支持指定别名。</li><li>目标表不支持复制表。</li></ul>
    </td>
