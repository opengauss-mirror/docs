...
3.  使用MERGE INTO 语句将源表products的数据合并至目标表newproducts。
    ...
    **表 1**  MERGE INTO语句参数说明
    ...
    <a name="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"></a><a name="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"></a><ul id="zh-cn_topic_0237121140_zh-cn_topic_0165787112_ul142032147713"><li>目标表支持指定别名。</li></ul>
    </td>
