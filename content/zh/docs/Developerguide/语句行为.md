# 语句行为<a name="ZH-CN_TOPIC_0242371522"></a>
...
## default\_storage\_nodegroup<a name="zh-cn_topic_0237124732_section1785192713303"></a>
...
**取值范围：**字符串。空字符串表示所有的临时对象仅在当前数据库默认的表空间中创建，请参见[default\_tablespace](#zh-cn_topic_0237124732_zh-cn_topic_0059779117_sa058ceea3c3142f0a8a40b5799a682d3)。
...
分布式场景中该参数属于SIGHUP类型参数，集中式场景中该参数属于USERSET类型参数，请参考[表2](重设参数.md#zh-cn_topic_0237121562_zh-cn_topic_0059777490_t290c8f15953843db8d8e53d867cd893d)中对应设置方法进行设置。
