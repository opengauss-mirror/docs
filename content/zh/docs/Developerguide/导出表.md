# 导出表<a name="ZH-CN_TOPIC_0242370321"></a>
...
2.  使用gs\_dump同时导出指定表hr.staffs和hr.employments。
    ...
    **表 1**  常用参数说明
    ...
    <td class="cellrowborder" valign="top" width="31.669999999999998%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0237121171_p1898043113581"><a name="zh-cn_topic_0237121171_p1898043113581"></a><a name="zh-cn_topic_0237121171_p1898043113581"></a>-W Bigdata@123</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="44.16%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0237121171_p14838631464"><a name="zh-cn_topic_0237121171_p14838631464"></a><a name="zh-cn_topic_0237121171_p14838631464"></a>指定服务器所监听的TCP端口或本地Unix域套接字后缀，以确保连接。</p>
    </td>
