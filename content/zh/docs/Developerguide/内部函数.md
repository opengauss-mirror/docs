...
-   内部类型处理函数
    ...
    <tr id="row14631118192014"><td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p06312018142011"><a name="p06312018142011"></a><a name="p06312018142011"></a>jsonb_in</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p1163191815203"><a name="p1163191815203"></a><a name="p1163191815203"></a>jsonb_out</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p1063119180207"><a name="p1063119180207"></a><a name="p1063119180207"></a>jsonb_recv</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p15631718132010"><a name="p15631718132010"></a><a name="p15631718132010"></a>jsonb_send</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p116318183201"><a name="p116318183201"></a><a name="p116318183201"></a>-</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.175747275817258%"><p id="p12632101882016"><a name="p12632101882016"></a><a name="p12632101882016"></a>-</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.395681295611315%"><p id="p9632318122019"><a name="p9632318122019"></a><a name="p9632318122019"></a>-</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   聚合操作内部函数
    ...
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p717574223519"><a name="p717574223519"></a><a name="p717574223519"></a>json_agg_finalfn</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p2175134212351"><a name="p2175134212351"></a><a name="p2175134212351"></a>json_agg_transfn</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p18175194220352"><a name="p18175194220352"></a><a name="p18175194220352"></a>json_object_agg_finalfn</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p10175174273517"><a name="p10175174273517"></a><a name="p10175174273517"></a>json_object_agg_transfn</p>
    </td>
...
-   Gin索引内部功能函数
    ...
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p462220583710"><a name="p462220583710"></a><a name="p462220583710"></a>gin_compare_jsonb</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p13358139112315"><a name="p13358139112315"></a><a name="p13358139112315"></a>gin_consistent_jsonb</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p73586398239"><a name="p73586398239"></a><a name="p73586398239"></a>gin_consistent_jsonb_hash</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p835863910232"><a name="p835863910232"></a><a name="p835863910232"></a>gin_extract_jsonb</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p235843932317"><a name="p235843932317"></a><a name="p235843932317"></a>gin_extract_jsonb_hash</p>
    </td>
    </tr>
    <tr id="row735718396231"><td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p735820396237"><a name="p735820396237"></a><a name="p735820396237"></a>cginbuild</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p133581397239"><a name="p133581397239"></a><a name="p133581397239"></a>gin_extract_jsonb_query</p>
    </td>
    <td class="cellrowborder" valign="top" width="14.285714285714285%"><p id="p462220583710"><a name="p462220583710"></a><a name="p462220583710"></a>gin_triconsistent_jsonb</p>
    </td>
