...
-   a表示产生于A DB中与numtodsinterval函数相匹配的输出结果，详细请参考[numtodsinterval](时间和日期处理函数和操作符.md#zh-cn_topic_0237121972_zh-cn_topic_0059779084_lf9dae2de082b41c094177f70cf798433)。
