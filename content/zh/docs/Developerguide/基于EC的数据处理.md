# 基于EC的数据处理<a name="ZH-CN_TOPIC_0311524282"></a>
...
4.  配置（远端）openGauss数据库实例侦听参数。
    ...
    2.  设置远端数据库实例的侦听IP（通过remoteip设置无需执行此步骤）。
...
[CREATE DATA SOURCE](zh-cn_topic_0289900178.md)，[SQL on Oracle](SQL-on-Oracle.md)，《工具参考》中“服务端工具 \> gs\_om”章节
