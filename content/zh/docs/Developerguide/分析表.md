# 分析表<a name="ZH-CN_TOPIC_0242370296"></a>
...
-   [track\_counts](查询和索引统计收集器.md#zh-cn_topic_0237124727_zh-cn_topic_0059779313_s3f4fb0b1004041f69e1454c701952411)  参数需要设置为on，表示开启收集收据库统计数据功能。
