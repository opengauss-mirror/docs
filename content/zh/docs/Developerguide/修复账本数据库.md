...
-   当在异常情况或表被损坏时需要使用[ledger\_gchain\_repair\(tex...](zh-cn_topic_0000001147093197.md#li1188094681312)或[ledger\_hist\_repair\(text,...](zh-cn_topic_0000001147093197.md#li688019463130)接口对全局区块表或用户历史表进行修复，修复后调用全局区块表或用户历史表校验接口结果为true。
