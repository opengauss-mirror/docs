...
4.  PostGIS依赖库安装。
    ...
    2).  从网站 https://gitcode.com/opengauss/openGauss-third_party/blob/master/gpl_dependency/postgis/postgis_2.4.2-1.patch 下载补丁文件到$GAUSSHOME目录，并打入补丁。
    ...
    3).  从网站https://gitcode.com/opengauss/openGauss-third_party/blob/master/gpl_dependency/postgis/extension_dependency.h
    下载postgis依赖头文件到$GAUSSHOME/include/postgresql/server/。 
