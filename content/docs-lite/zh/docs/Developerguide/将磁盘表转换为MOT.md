# 将磁盘表转换为MOT<a name="ZH-CN_TOPIC_0289899851"></a>

磁盘表直接转换为MOT尚不能实现，这意味着尚不存在将基于磁盘的表转换为MOT的ALTER TABLE语句。

下面介绍如何手动将基于磁盘的表转换为MOT，如何使用gs\_dump工具导出数据，以及如何使用gs\_restore工具导入数据。

## 前置条件检查<a name="zh-cn_topic_0283137611_zh-cn_topic_0280525135_section7473422"></a>
...
## 转换<a name="zh-cn_topic_0283137611_zh-cn_topic_0280525135_section151935"></a>
...
## 转换示例<a name="zh-cn_topic_0283137611_zh-cn_topic_0280525135_section1367417"></a>
