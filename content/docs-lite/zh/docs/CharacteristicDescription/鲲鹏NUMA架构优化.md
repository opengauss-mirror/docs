# 鲲鹏NUMA架构优化<a name="ZH-CN_TOPIC_0000001105075478"></a>
...
鲲鹏NUMA架构优化，主要面向鲲鹏处理器架构特点、ARMv8指令集等，进行相应的系统优化，涉及到操作系统、软件架构、锁并发、日志、原子操作、Cache访问等一系列的多层次优化，从而大幅提升了数据库在鲲鹏平台上的处理性能。
