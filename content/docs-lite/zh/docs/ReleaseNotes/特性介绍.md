...
- DataKit：录制回放功能增强。[录制回放工具](../../../../zh/docs/AboutopenGauss/录制回放工具.md)
...
- DataKit：安装部署优化。[DataKit](../../../../zh/docs/AboutopenGauss/工具链_DataKit.md)

  - 支持添加IPV6实例。
  - 安装过程解除对root权限的依赖。

- DataKit：对象管理。[业务开发](../../../../zh/docs/ToolandCommandReference/datakit/data-studio/Datakit_业务开发.md)
