# gs\_dumpall<a name="ZH-CN_TOPIC_0000001266144741"></a>
...
-   gs\_dumpall通过调用gs\_dump来完成openGauss数据库中各数据库的SQL脚本文件导出，该脚本文件包含将数据库恢复为其保存时的状态所需要的全部SQL语句。
...
使用gs\_dumpall一次导出openGauss数据库的所有数据库。
