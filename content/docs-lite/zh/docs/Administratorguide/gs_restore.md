# gs\_restore<a name="ZH-CN_TOPIC_0000001265864781"></a>

## 背景信息<a name="zh-cn_topic_0059777561_section182531928123515"></a>

gs\_restore是openGauss提供的针对gs\_dump导出数据的导入工具。通过此工具可将gs\_dump导出生成的文件进行导入。
...
## 命令格式<a name="zh-cn_topic_0059777561_s5a64660d88db4dfb8e2b35d0b4645264"></a>
...
## 参数说明<a name="zh-cn_topic_0059777561_sc666a8c818084bad8e23afd6e79dd659"></a>
...
-   -h, --host=HOSTNAME
    ...
    该参数只针对openGauss数据库外，对openGauss数据库内本机只能用127.0.0.1。
...
## 示例<a name="zh-cn_topic_0059777561_s87e334fd72aa475782287207b9d7fb79"></a>
...
## 相关命令<a name="zh-cn_topic_0059777561_sd2827da1c60248c0b0bfffc406b9f668"></a>
