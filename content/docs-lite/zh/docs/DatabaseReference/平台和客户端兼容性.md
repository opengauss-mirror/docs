...
该参数属于USERSET类型参数，请参考[表1](../DatabaseAdministrationGuide/参数设置.md#zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
...
该参数属于USERSET类型参数，请参考表[表1](../DatabaseAdministrationGuide/参数设置.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
...
<tr id="row14769111017290">
    <td class="cellrowborder" valign="top" width="24.43%" headers="mcps1.2.3.1.1 ">float_compat</td>
    <td class="cellrowborder" valign="top" width="75.57000000000001%" headers="mcps1.2.3.1.2 ">在A兼容模式下，开启此参数后，FLOAT[(p)]映射至numeric，此时精度p为二进制精度，p取值范围为[1,126]。</p></td>
</tr>
<tr id="row14769111017290">
    <td class="cellrowborder" valign="top" width="24.43%" headers="mcps1.2.3.1.1 ">float_dec_precision</td>
    <td class="cellrowborder" valign="top" width="75.57000000000001%" headers="mcps1.2.3.1.2 ">在A兼容模式，已经开启float_compat的场景下，开启此参数，FLOAT[(p)]映射至numeric，此时精度p为十进制精度，p取值范围为[1,38]。</p>
<pre class="screen" id="screen495515577331">
openGauss=# set behavior_compat_options='float_compat,float_dec_precision';
SET
openGauss=# create table t1(col1 float(5), col2 float(12));
CREATE TABLE
openGauss=# insert into t1 values(1234.678901324546667,1234.678901324546667);
INSERT 0 1
openGauss=# select * from t1;
  col1  |     col2
--------+---------------
 1234.7 | 1234.67890132
(1 row)
</pre>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="81.05%" headers="mcps1.2.3.1.2 "><p id="p10868102371910"><a name="p10868102371910"></a><a name="p10868102371910"></a>out重载条件下，有重载函数；将对out出参常量进行检查，禁止out出参为常量报错。</p>
</td>
</tr>
</tbody>
</table>
...
该参数属于USERSET类型参数，仅支持[表2](../DatabaseAdministrationGuide/参数设置.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t290c8f15953843db8d8e53d867cd893d)中对应设置方法3进行设置。
...
该参数属于USERSET类型参数，请参考[表1](../DatabaseAdministrationGuide/参数设置.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。仅在设置会话级时生效，设置数据库级和用户级不生效。
