...
<tr id="row14769111017290">
    ...
    <td class="cellrowborder" valign="top" width="75.57000000000001%" headers="mcps1.2.3.1.2 ">在 A 兼容模式下，开启此选项后，`FLOAT[(p)]` 映射至 `numeric`，二进制精度 `p` 取值范围为 [1,126]；未开启时取值范围为 [1, 53]。</p></td>
</tr>
