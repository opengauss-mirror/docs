...
### 下载镜像包并加载
- 下载镜像包（以openGauss6.0.2B002/arm22_03下的包为例）
``` bash
$ wget https://download-opengauss.osinfra.cn/archive_test/6.0.2/6.0.2B002/arm_2203/openGauss-Lite-Docker-6.0.2-aarch64.tar
```
- 加载镜像
``` bash
