...
-   stack参数，详细参见[表8](#table65592307777)。
    ...
    **表 1**  option参数
    ...
    <td class="cellrowborder" valign="top" width="74.7%" headers="mcps1.2.3.1.2 "><p id="p137261925144719"><a name="p137261925144719"></a><a name="p137261925144719"></a>通过对日志预解析找到有效日志尾部，启动接收物理日志的walreceiver线程。</p>
    </td>
    </tr>
    </tbody>
    </table>
