...
-   一种是声明字段的类型为[序列整型](../SQLReference/数值类型.md#zh-cn_topic_0283136992_zh-cn_topic_0237121927_zh-cn_topic_0059778296_t5262f987c61c4a8caff8c8037e912874)，由数据库在后台自动创建一个对应的Sequence。
