...
-   **enable\_redo\_log = true**
    ...
    指定是否使用重做日志以获得持久性。有关重做日志的详细信息，请参阅[MOT日志记录：WAL重做日志](MOT持久性.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section129831140121218)。
...
-   **enable\_group\_commit = false**
    ...
    有关WAL重做日志的详细信息，请参阅[MOT日志记录：WAL重做日志](MOT持久性.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section129831140121218)。
...
-   **group\_commit\_timeout = 10 ms**
    ...
    有关同步组提交日志记录的详细信息，请参阅[MOT日志类型](MOT持久性.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section125771537134)。
...
>![](public_sys-resources/icon-note.gif) **说明：** 
>
>有关配置的更多信息，请参阅[MOT检查点](MOT持久性.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section182761535131617)。
