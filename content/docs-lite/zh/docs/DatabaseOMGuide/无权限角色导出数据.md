# 无权限角色导出数据<a name="ZH-CN_TOPIC_0289899959"></a>
...
2.  使用gs\_dump导出human\_resource数据库数据。
    ...
    **表 1**  常用参数说明
    ...
    <td class="cellrowborder" valign="top" width="31.669999999999998%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0283136762_zh-cn_topic_0237121175_p1662514481776"><a name="zh-cn_topic_0283136762_zh-cn_topic_0237121175_p1662514481776"></a><a name="zh-cn_topic_0283136762_zh-cn_topic_0237121175_p1662514481776"></a>--rolepassword  xxxxxx</p>
    </td>
    </tr>
