# 使用CREATE TABLE执行深层复制<a name="ZH-CN_TOPIC_0289900646"></a>

该方法使用CREATE TABLE语句创建原始表的副本，将原始表的数据填充至副本并重命名副本，完成原始表的复制。

在创建新表时，可以指定表以及列属性，比如主键。

## 操作步骤<a name="zh-cn_topic_0283136747_zh-cn_topic_0237121142_zh-cn_topic_0165787114_section827316454146"></a>
