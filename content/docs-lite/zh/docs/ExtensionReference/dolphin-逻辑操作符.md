...
- &&
  ...
  <tr>
      <td>字符型</td>
      <td>字符型的转换根据字符型的首部是否为数值，若不为数值，则直接转换成为布尔假；若为数值，则等于0的数值转换为布尔假否则转换为布尔真，然后再进行逻辑与运算。</td>
  </tr>
  </table>
...
- ||
  ...
  <tr>
      <td>字符型</td>
      <td>字符型的转换根据字符型的首部是否为数值，若不为数值，则直接转换成为布尔假；若为数值，则等于0的数值转换为布尔假否则转换为布尔真，然后再进行逻辑或运算。</td>
  </tr>
  </table>
