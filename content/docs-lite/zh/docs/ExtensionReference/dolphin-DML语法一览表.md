...
## 导入数据<a name="zh-cn_topic_0283137022_zh-cn_topic_0237122050_zh-cn_topic_0059778364_s1633132317ef42edba6e4afdbb2d6b15"></a>

LOAD DATA是用于一个文件拷贝数据到一个表，请参考[LOAD DATA](dolphin-LOAD-DATA.md)。
