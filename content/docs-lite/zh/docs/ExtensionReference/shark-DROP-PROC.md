...
-   本章节只包含shark新增的语法，原openGauss的语法未做删除和修改。原openGauss的DROP PROCEDURE语法请参考章节[DROP PROCEDURE](../SQLReference/DROP-PROCEDURE.md)。
...
[DROP PROCEDURE](../SQLReference/DROP-PROCEDURE.md)