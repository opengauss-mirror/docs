...
-   账本数据库校验功能目前提供两种校验接口，分别为：[ledger\_hist\_check\(text,...](账本数据库的函数.md#li48809468134)和[ledger\_gchain\_check\(text...](账本数据库的函数.md#li6880446141312)。普通用户调用校验接口，仅能校验自己有权限访问的表。
