...
## expected\_computing\_nodegroup<a name="zh-cn_topic_0283136675_zh-cn_topic_0237124716_section746841514523"></a>
...
-   Node Group名（[enable\_nodegroup\_debug](#zh-cn_topic_0283136675_zh-cn_topic_0237124716_section1426622145210)被设置为off）：候选计算Node Group列表包含算子操作对象所在的Node Group和该指定的Node Group
-   Node Group名（[enable\_nodegroup\_debug](#zh-cn_topic_0283136675_zh-cn_topic_0237124716_section1426622145210)被设置为on）：候选计算Node Group为指定的Node Group

**默认值**：query

## enable\_nodegroup\_debug<a name="zh-cn_topic_0283136675_zh-cn_topic_0237124716_section1426622145210"></a>

**参数说明**：控制优化器在多Node Group环境下，是否使用强制弹性计算。Node Group目前为内部用机制，用户无需设置。

该参数只在[expected\_computing\_nodegroup](#zh-cn_topic_0283136675_zh-cn_topic_0237124716_section746841514523)被设置为具体Node Group时生效。
