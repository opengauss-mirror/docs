...
以下是基于Arm/鲲鹏架构的华为TaiShan 2280 v2服务器（2路128核<sup>\[</sup>[对比：磁盘与MOT](对比-磁盘与MOT.md)<sup>\]</sup>）和TaiShan 2480 v2服务器（4路256核<sup>\[</sup>[对比：磁盘与MOT](对比-磁盘与MOT.md)<sup>\]</sup>）上运行MOT时的建议配置。
