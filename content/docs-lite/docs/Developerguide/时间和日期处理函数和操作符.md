...
-   numtodsinterval\(num, interval\_unit\)
    ...
    可以通过设置参数[IntervalStyle](区域和格式化.md#zh-cn_topic_0283136798_zh-cn_topic_0237124733_zh-cn_topic_0059778109_s89302a8dcd7f46ecb7167574d6397dc0)为a，兼容该函数interval输出格式。
