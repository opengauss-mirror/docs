# DB4AI.ARCHIVE\_SNAPSHOT<a name="EN-US_TOPIC_0000001195431133"></a>

**ARCHIVE\_SNAPSHOT**  archives snapshots for the DB4AI feature. You can invoke  **ARCHIVE SNAPSHOT**  to implement this function. After taking effect, the snapshot cannot be used for training.

**Table  1**  DB4AI.ARCHIVE\_SNAPSHOT input parameters and return values
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p169381236173517"><a name="p169381236173517"></a><a name="p169381236173517"></a>Name of the schema storing snapshots. The default value is the current user.</p>
</td>
</tr>
