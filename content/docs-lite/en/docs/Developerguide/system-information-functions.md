...
-   has\_cek\_privilege\(user, cek, privilege\)
    ...
    **Table  3**  Parameter type description
    ...
    <td class="cellrowborder" valign="top" width="53.30533053305331%" headers="mcps1.2.5.1.4 "><p id="p6436141613313"><a name="p6436141613313"></a><a name="p6436141613313"></a>Username or ID</p>
    </td>
    </tr>
...
-   has\_cmk\_privilege\(user, cmk, privilege\)
    ...
    **Table  4**  Parameter type description
    ...
    <td class="cellrowborder" valign="top" width="46.26462646264626%" headers="mcps1.2.5.1.4 "><p id="p1515723017418"><a name="p1515723017418"></a><a name="p1515723017418"></a>Username or ID</p>
    </td>
    </tr>
...
-   pg\_has\_role\(role, privilege\)
    ...
    Note:  **pg\_has\_role**  checks whether a user can access a role in a particular way. Its argument possibilities are analogous to  **has\_table\_privilege**, except that  **public**  is not allowed as a username. The desired access permission type must evaluate to some combination of  **MEMBER**  or  **USAGE**.  **MEMBER**  denotes direct or indirect membership in the role \(that is, the right to do  **SET ROLE**\), while  **USAGE**  denotes the permissions of the role are available without doing  **SET ROLE**.
...
-   has\_any\_privilege\(user, privilege\)
    ...
    **Table  11**  Parameter type description
    ...
    <td class="cellrowborder" valign="top" width="46.96469646964697%" headers="mcps1.2.5.1.4 "><p id="p84766343422"><a name="p84766343422"></a><a name="p84766343422"></a>An existing username.</p>
    </td>
    </tr>
...
-   pg\_shared\_memory\_detail
    ...
    Description: Returns usage information about all generated shared memory contexts. For details about each column, see  [GS\_SHARED\_MEMORY\_DETAIL](gs_shared_memory_detail.md).
