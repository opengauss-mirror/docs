...
- You have successfully executed the  **gs\_preinstall**  script. that is, you have completed operations described in  [initializing the installation environment](initializing_the_installation_environment.md).
