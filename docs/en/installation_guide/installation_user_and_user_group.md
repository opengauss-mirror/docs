...
<p id="en-us_topic_0241802568_p34816564"><a name="en-us_topic_0241802568_p34816564"></a><a name="en-us_topic_0241802568_p34816564"></a>This user is the OS user specified by the <strong id="b150883819346"><a name="b150883819346"></a><a name="b150883819346"></a>-U</strong> parameter in <a href="initializing_the_installation_environment.md">Initializing the Installation Environment</a>. If this user exists, delete it or change the initial user. For security purposes, the user group is planned as follows:</p>
