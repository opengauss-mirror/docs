...
- The software and hardware have been prepared based on the requirements in  [Setting up the Compilation Environment](setting_up_the_compilation_environment.md), and the code has been downloaded by referring to  [Downloading Code](#downloading-code).
