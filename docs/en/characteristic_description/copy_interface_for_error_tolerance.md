# Copy Interface for Error Tolerance<a name="EN-US_TOPIC_0000001135302867"></a>
...
For details, see [handling-import-errors](../database_om_guide/running_the_copy_from_stdin_statement_to_import_data.md).
