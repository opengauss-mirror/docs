...
- The encrypted syntax of stored procedures for some functions is supported. For details about the constraints, see [Encrypted Functions and Stored Procedures](../database_administration_guide/encrypted_functions_and_stored_procedures.md).
