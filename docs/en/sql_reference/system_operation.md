...
For details about how to collect statistics on tables in databases, see [ANALYZE | ANALYSE](analyze_analyse.md).
...
For details about how to set the constraint check mode for the current transaction, see [SET CONSTRAINTS](set_constraints.md).
