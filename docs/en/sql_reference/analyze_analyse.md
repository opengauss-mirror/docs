...
- Collect statistics about multiple columns.
    ...
    >[!NOTE]NOTE 
    >
    >- When collecting statistics about multiple columns, set the GUC parameter [default\_statistics\_target](../database_reference/other_optimizer_options.md#en-us_topic_0283137690_en-us_topic_0237124719_en-us_topic_0059779049_se18c86fcdf5e4a22870f71187436d815) to a negative value to sample data in percentage.
    >
