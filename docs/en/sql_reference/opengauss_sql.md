...
SQL consists of commands and functions that are used to manage databases and database objects. SQL can also forcibly implement the rules for data types, expressions, and texts. Therefore,  [SQL Reference](opengauss_sql.md)  describes data types, expressions, functions, and operators in addition to SQL syntax.
