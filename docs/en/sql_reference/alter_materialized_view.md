...
Statements and actions that can be used for  **ALTER MATERIALIZED VIEW**  are a subset of  **ALTER TABLE**  and have the same meaning when used for materialized views. For details, see  [ALTER TABLE](alter_table.md).
