# DBE\_SQL\_UTIL.disable\_sql\_patch<a name="EN-US_TOPIC_0000001314072137"></a>

disable\_sql\_patch is an interface function used to disable an SQL patch and return whether the execution is successful.

Only the initial, sysadmin, opradmin, and monadmin users have the permission to invoke this interface.

**Table 1** DBE\_SQL\_UTIL.disable\_sql\_patch input parameters and return values
...
<tr id="row20373193218513"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p1537313218511"><a name="p1537313218511"></a><a name="p1537313218511"></a>result</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p337323219510"><a name="p337323219510"></a><a name="p337323219510"></a>OUT bool</p>
</td>
