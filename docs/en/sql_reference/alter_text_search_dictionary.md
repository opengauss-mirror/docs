...
-   **option**
    ...
    Specifies the parameter name to be modified. Each type of dictionaries has a template containing their custom parameters. Parameters function in a way irrelevant to their setting sequence. For details about the parameters, see  [option](create_text_search_dictionary.md).
...
[CREATE TEXT SEARCH DICTIONARY](create_text_search_dictionary.md)  and  [DROP TEXT SEARCH DICTIONARY](drop_text_search_dictionary.md)
