...
- **DEFERRABLE | NOT DEFERRABLE**
    ...
    For details, see  [CREATE TABLE](create_table.md).
...
[ALTER TRIGGER](alter_trigger.md),  [DROP TRIGGER](drop_trigger.md), and  [ALTER TABLE](alter_table.md)
