...
1. Create a  **Simple**  dictionary.
    ...
    **english.stop**  is the full name of a file of stop words. For details about the syntax and parameters for creating a  **Simple**  dictionary, see  [CREATE TEXT SEARCH DICTIONARY](create_text_search_dictionary.md).
