...
- **configuration\_option**
    ...
    Specifies the text search configuration option. For details, see  [CREATE TEXT SEARCH CONFIGURATION](create_text_search_configuration.md).
...
See  [Examples](create_text_search_configuration.md#en-us_topic_0283137399_en-us_topic_0237122121_en-us_topic_0059777835_sc3a4aef5c0c0420eaf5a2e67097004a2)  in  **CREATE TEXT SEARCH CONFIGURATION**.
...
[CREATE TEXT SEARCH CONFIGURATION](create_text_search_configuration.md)  and  [DROP TEXT SEARCH CONFIGURATION](drop_text_search_configuration.md)
