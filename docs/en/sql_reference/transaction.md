...
This parameter is a  **USERSET**  parameter. Set it based on instructions provided in  [Table 1](transaction.md).
...
This parameter is a SUSET parameter. Set it based on method 3 in  [Table 1](transaction.md).
...
This parameter is a POSTMASTER parameter. Set it based on instructions provided in  [Table 1](transaction.md).
...
This parameter is a POSTMASTER parameter. Set it based on  [Table 2](transaction.md).
...
This parameter is a SIGHUP parameter. Set it based on  [Table 2](transaction.md).
