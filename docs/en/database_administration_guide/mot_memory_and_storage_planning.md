# MOT Memory and Storage Planning<a name="EN-US_TOPIC_0270171547"></a>
...
-   **Logging**
    ...
    >[!NOTE]NOTE 
    >You may refer to the  [STORAGE \(MOT\)](mot_configuration.md)  section for more information about configuration settings.
