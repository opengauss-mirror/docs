...
For details about the JDBC connection parameters, see  [Development Based on JDBC](../developer_guide/development_based_on_jdbc.md). To support JDBC operations on an encrypted database, set  **enable\_ce**  to  **1**. The following is an example:
