...
MOT supports both Primary, Secondary and Keyless indexes \(subject to the limitations specified in the  [Unsupported Index DDLs and Index](mot_sql_coverage_and_limitations.md#section143421450173815) section\).
