# MOT Sample TPC-C Benchmark<a name="EN-US_TOPIC_0270171506"></a>
...
Follow the instructions in the  [MOT Server Optimization – x86](mot_server_optimization.md)  section. The following section describes the key system-level optimizations for deploying the openGauss database on a Huawei Taishan server and on a Euler 2.8 operating system for ultimate performance.
