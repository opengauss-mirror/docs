...
<tbody><tr id="row18224718191112"><td class="cellrowborder" valign="top" width="34.88%" headers="mcps1.2.3.1.1 "><p id="p9224151831117"></p><a name="p9224151831117"></a><a name="p9224151831117"></a>The following error is returned when the primary database instance establishes the DR relationship:
...
<tbody><tr id="row2923357105515"><td class="cellrowborder" valign="top" width="34.79%" headers="mcps1.2.3.1.1 "><a name="p792325713550"></a><a name="p792325713550"></a>The following error is returned during a planned switchover in the primary database instance:
