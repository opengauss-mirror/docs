...
For a description of the limitations of supported features for MOT tables, such as data types, see the  [MOT SQL Coverage and Limitations](mot_sql_coverage_and_limitations.md)  section.
