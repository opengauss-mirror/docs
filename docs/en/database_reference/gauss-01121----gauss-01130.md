...
Solution: Change the parameter value to a value recognizable to the system. For the value types recognizable to the system, see  [Data Types.md](../sql_reference/numeric_types.md).
