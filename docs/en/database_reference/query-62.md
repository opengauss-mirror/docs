...
This parameter is an INTERNAL parameter. Set it based on instructions provided in  [Table 1](../database_administration_guide/reset_parameters.md#en-us_topic_0283137176_en-us_topic_0237121562_en-us_topic_0059777490_t91a6f212010f4503b24d7943aed6d846).
...
This parameter is a USERSET parameter. Set it based on instructions provided in  [Table 1](../database_administration_guide/reset_parameters.md#en-us_topic_0283137176_en-us_topic_0237121562_en-us_topic_0059777490_t91a6f212010f4503b24d7943aed6d846). The value is case-insensitive.
...
>[!NOTE]NOTE 
>If the full SQL tracing level is not  **OFF**, the current SQL tracing level is the higher level \(L2 \> L1 \> L0\) of the full SQL and slow SQL statements. For details about the levels, see  [Table 1](../database_administration_guide/reset_parameters.md).
