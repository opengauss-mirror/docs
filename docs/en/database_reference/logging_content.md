...
- **off**: Compared with this option,  **[log\_min\_duration\_statement](logging_time.md#en-us_topic_0283137528_en-us_topic_0237124722_en-us_topic_0059778452_s62cf0fb833324a82a841f02134a932e5)**  forcibly records the query text.
...
**Parameter description**: If the time for which a session waits to acquire a lock is longer than the value of  **[deadlock\_timeout](lock_management.md#en-us_topic_0283136691_en-us_topic_0237124735_en-us_topic_0059778102_se697b4ff00b643938b67eb5e08206cd5)**, this parameter specifies whether to record this message in the database. This is useful in determining if lock waits are causing poor performance.
...
**Parameter description**: Specifies the time zone used for timestamps written in the server log. Different from  [TimeZone](locale_and_formatting.md#en-us_topic_0283136798_en-us_topic_0237124733_en-us_topic_0059778109_sa60c5d71347646c2ad97ccb7541c6f12), this parameter takes effect for all sessions in the database.
...
logging_module
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ALL,on(),off(GUC,SLRU,MEM_CTL,AUTOVAC,CACHE,ADIO,SSL,TBLSPC,WLM,EXECUTOR,VEC_EXECUTOR,LLVM,OPT,OPT_REWRITE,OPT_JOIN,OPT_AGG,OPT_SUBPLAN,OPT_SETOP,OPT_SKEW,UDF,COOP_ANALYZE,WLMCP,ACCELERATE,T,PLANHINT,SNAPSHOT,XACT,HANDLE,CLOG,EC,REMOTE,CN_RETRY,PLSQL,TEXTSEARCH,SEQ,REDO,FUNCTION,PARSER,INSTR,INCRE_CKPT,DBL_WRT,RTO,HEARTBEAT)
(1 row)
```
...
## enable\_nls<a name="en-us_topic_0283137548_en-us_topic_0237124743_en-us_topic_0059778871_sf839417816c74a37a3bdb4138d946c55"></a>
