...
Solution: Check user permissions. For permissions to create users, see  [managing-users-and-their-permissions.md](../database_administration_guide/default_permission_mechanism.md).
