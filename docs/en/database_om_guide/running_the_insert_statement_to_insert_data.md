# Running the INSERT Statement to Insert Data<a name="EN-US_TOPIC_0242370280"></a>

Run the  **[INSERT](../sql_reference/insert.md)**  statement to write data into the openGauss database in either of the following ways:

- Use the client tool provided by the openGauss database to write data into openGauss.

    For details, see  [Inserting Data to Tables](../database_administration_guide/inserting_data_to_tables.md).
...
- Connect to the database using the JDBC or ODBC driver and run the  **INSERT**  statement to write data into the openGauss database.
    ...
    For details, see  [Connecting to a Database](../developer_guide/connecting_to_a_database_jdbc.md).
