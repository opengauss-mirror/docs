...
-   Currently, logical logs are extracted from host nodes. To perform logical replication, the GUC parameter  **[ssl](../database_reference/security_and_authentication_postgresql_conf.md#en-us_topic_0283137371_en-us_topic_0237124696_en-us_topic_0059778664_s8c4647db116f44c4b9ce3dceee3d6ffa)**  must be set to  **on**  on host nodes.

    >[!NOTE]NOTE 
    >For security purposes, ensure that SSL connections are enabled.


-   The GUC parameter  **[wal\_level](../database_reference/settings-60.md#en-us_topic_0283137354_en-us_topic_0237124707_en-us_topic_0059778393_s2c76f5957066407a959191148f2c780f)**  is set to  **logical**.
