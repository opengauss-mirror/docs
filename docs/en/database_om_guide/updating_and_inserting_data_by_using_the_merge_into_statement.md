...
3. Run the  **MERGE INTO**  statement to merge data in the source table  **products**  into the target table  **newproducts**.
   ...
   ```
    ...
    For details on parameters in the statement, see  [Table 1](#en-us_topic_0237121140_en-us_topic_0165787112_table1973914406416). For more information, see  [MERGE INTO](../sql_reference/merge_into.md).
