...
- 集群管理组件增量升级操作不需要执行前置操作，请参考[gs_upgradectl](../tool_and_commandreference/gs_upgradectl.md)中示例六进行集群管理组件的升级。
...
>[!NOTE]说明
>表1中的2-5项详细操作请参照 **[升级前准备与检查](preparing_for_and_checking_the_upgrade.md)**。
>
## 检查安装版本是否支持集群管理组件升级
