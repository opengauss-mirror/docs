...
- 逻辑日志目前从主机节点中抽取，默认关闭SSL连接，如果进行逻辑复制，需要先配置GUC参数[ssl](../database_reference/security_and_authentication_postgresql_conf.md#zh-cn_topic_0237124696_zh-cn_topic_0059778664_s8c4647db116f44c4b9ce3dceee3d6ffa)=on。
