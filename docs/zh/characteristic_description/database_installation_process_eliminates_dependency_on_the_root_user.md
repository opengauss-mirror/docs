...
1. 有些操作，普通用户仍旧没有执行权限，还是需要root用户前提执行，可以参考以下资料。
    ...
    <a href="../installation_guide/prerequisites.md">前提操作</a>
...
gs_checkos文档：<a href="../tool_and_commandreference/gs_checkos.md">校验</a>

gs_preisntall文档：<a href="../tool_and_commandreference/gs_preinstall.md">预安装</a>
