...
详细的配置方法和使用指导请参考[配置DPA哈希聚合加速](https://docs.opengauss.org/zh/docs/latest/performance_tuning_guide/dpa_hash_aggregation_acceleration.html)。
...
- [向量化引擎](https://docs.opengauss.org/zh/docs/latest/performance_tuning_guide/vectorized_engine.html)
