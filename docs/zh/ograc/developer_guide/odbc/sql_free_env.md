...
用于释放环境句柄，其功能可被SQLFreeHandle函数替代。
...
<td class="cellrowborder" valign="top" width="76.73%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0238272884_zh-cn_topic_0237120414_zh-cn_topic_0059778058_af3af585891f340b49049298be113dce4"><a name="zh-cn_topic_0238272884_zh-cn_topic_0237120414_zh-cn_topic_0059778058_af3af585891f340b49049298be113dce4"></a><a name="zh-cn_topic_0238272884_zh-cn_topic_0237120414_zh-cn_topic_0059778058_af3af585891f340b49049298be113dce4"></a>要释放的环境句柄。</p>
</td>
</tr>
</tbody>
</table>
...
-   SQL\_ERROR：执行失败，环境句柄未被释放。
-   SQL\_INVALID\_HANDLE：表示传入的环境句柄无效。

## 注意事项<a name="zh-cn_topic_0238272884_zh-cn_topic_0237120414_zh-cn_topic_0059778058_s9076893176f14464a773531cbd9e81b4"></a>

如果SQLFreeEnv返回SQL\_ERROR，环境句柄仍然有效。为了使得代码更健壮并易于维护，建议使用标准化接口SQLFreeHandle替代SQLFreeEnv。
