...
- 支持标准SQL
    ...
    openGauss数据库支持SQL:2011大部分的核心特性，同时还支持部分的可选特性，具体的特性列表可以参考[《SQL参考》中“SQL语言结构和语法\>SQL语法”](../sql_reference/sql_syntax_formats.md)章节。
...
![](figures/Column-storage-diagram.png)
...
![](figures/Xlog-lock-less-Design.png)
...
![](figures/Kunpeng-NUMA-architecture-optimization-diagram.png)
...
目前仅支持行存表加密，更多特性约束请参见[《关于openGauss》](../about_opengauss/about_opengauss.md)中特性描述。
