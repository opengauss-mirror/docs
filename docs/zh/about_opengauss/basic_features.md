...
- 标准SQL支持
    ...
    支持标准的SQL92/SQL99/SQL2003/SQL2011规范，支持GBK、GB18030、GB18030_2022、UTF-8、SQL ASCII以及Latin-1字符集，支持SQL标准函数与分析函数，支持存储过程。
...
- 向量化执行
    ...
    **图 1**  向量化执行引擎<a name="zh-cn_topic_0283136537_zh-cn_topic_0237080624_zh-cn_topic_0231764690_zh-cn_topic_0059777898_f9d90aebe179a40759039d0263492489d"></a>  
    ...
    ![](figures/Vectorization-Execution-Engine.png)
...
- 行列混合存储引擎
    ...
    **图 2**  行列混存引擎<a name="zh-cn_topic_0283136537_zh-cn_topic_0237080624_zh-cn_topic_0231764690_zh-cn_topic_0059777898_fbb2af39ce12a419cb437829aaf1cf4fb"></a>  
    ...
    ![](figures/openGauss-Row-Column-Mixed-Storage-Engine.png)
...
- 索引多版本
    ...
    **图 3**  UBtree与Btree查找、更新比较示意图<a name="fig38821655122012"></a>  
    ![](figures/Comparison-diagram-of-UBTree-and-BTree-search-update.png)
...
- 密态数据库数据流图
    ...
    **图 7**  密态数据库数据流图<a name="fig19889211143016"></a>  
    ![](figures/Data-Flow-Diagram-of-Dense-Database.png)
...
![](figures/Schematic-diagram-of-disaster-recovery-architecture-for-two-locations-and-three-centers-in-openGauss.png)
