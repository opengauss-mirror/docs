...
- **[客户端连接的字符集和字符序](charcater_set_and_collation_of_client_connections.md)**

- **[数据库级字符集和字符序](database_level_character_set_and_collation.md)**

- **[模式级字符集和字符序](mode_level_character_set_and_collation.md)**

- **[表级字符集和字符序](table_level_character_set_and_collation.md)**

- **[列级字符集和字符序](column_level_character_set_and_collation.md)**

- **[字符类型表达式的字符集和字符序](character_set_and_collation_of_character_type_espressions.md)**

- **[字符集和字符序合并规则](character_set_and_collation_merge_rules.md)**
