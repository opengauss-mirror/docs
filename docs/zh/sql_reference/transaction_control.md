...
openGauss通过START TRANSACTION和BEGIN语法启动事务，请参考[START TRANSACTION](start_transaction.md)和[BEGIN](begin.md)。

## 设置事务<a name="zh-cn_topic_0283137498_zh-cn_topic_0237122048_zh-cn_topic_0059777755_safc73bb82c674a69a44e59eca4831fb1"></a>

openGauss通过SET TRANSACTION或者SET LOCAL TRANSACTION语法设置事务，请参考[SET TRANSACTION](set_transaction.md)。

## 提交事务<a name="zh-cn_topic_0283137498_zh-cn_topic_0237122048_zh-cn_topic_0059777755_sf5fd4452e6f74585b579cf647848bd85"></a>

openGauss通过COMMIT或者END可完成提交事务的功能，即提交事务的所有操作，请参考[COMMIT | END](commit_end.md)。
