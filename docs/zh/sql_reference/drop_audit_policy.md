...
请参考CREATE AUDIT POLICY的[示例](create_audit_policy.md#section7854941155112)。

## 相关链接<a name="section12181292265"></a>

[ALTER AUDIT POLICY](alter_audit_policy.md)，[CREATE AUDIT POLICY](create_audit_policy.md)。
