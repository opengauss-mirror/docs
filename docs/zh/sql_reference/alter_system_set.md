...
- 通过配置[audit\_set\_parameter](../database_reference/action_trail.md#zh-cn_topic_0283136929_zh-cn_topic_0237124747_zh-cn_topic_0059777487_sc59738d0efe94f909306fde1f3d04f1e)参数，可以配置此操作是否被审计。
- 操作可被备机同步（资源池化模式不支持参数同步）。
