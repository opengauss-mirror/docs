...
本示例假定用户已预先成功创建控制组（创建控制组请参考[设置控制组](../performance_tuning_guide/resource_management_preparation.md)）。
...
[ALTER RESOURCE POOL](alter_resource_pool.md)，[DROP RESOURCE POOL](drop_resource_pool.md)
