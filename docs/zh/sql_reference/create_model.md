...
- **hyper\_parameter\_name**
    ...
    取值范围：字符串，针对不同算法超参类型范围不同，取值范围详情请参考：[表2](../characteristic_description/aifeature_guide/db4ai_query_for_model_training_and_prediction.md#table15985527185615)。

- **hp\_value**

    超参数值。

    取值范围：字符串，针对不同算法范围不同，取值范围详情请参考：[表3](../characteristic_description/aifeature_guide/db4ai_query_for_model_training_and_prediction.md#table86881521502)。
...
[DROP MODEL](drop_model.md)，[PREDICT BY](predict_by.md)
