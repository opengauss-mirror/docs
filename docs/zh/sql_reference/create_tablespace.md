...
[CREATE DATABASE](create_database.md)，[CREATE TABLE](create_database.md)，[CREATE INDEX](create_index.md)，[DROP TABLESPACE](drop_tablespace.md)，[ALTER TABLESPACE](alter_tablespace.md)
