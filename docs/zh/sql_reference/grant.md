...
- **将系统权限授权给角色或用户**
    ...
    有关系统权限的详细信息，请参见[CREATE-ROLE](../sql_reference/create_role.md)。
...
>[!NOTE]说明
>
>用户被授予任何一种ANY权限后，用户对public模式和用户模式具有USAGE权限，对[表1](../../zh/sql_reference/brief_tutorial/schema.md)中除public之外的系统模式没有USAGE权限。
...
[REVOKE](revoke.md)，[ALTER DEFAULT PRIVILEGES](alter_default_privileges.md)
