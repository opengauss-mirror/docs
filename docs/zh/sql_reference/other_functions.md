...
- local\_redo\_stat\(\)
    ...
    **表 4**  local\_double\_write\_stat参数说明
    ...
    <td class="cellrowborder" valign="top" width="60.01600160016001%" headers="mcps1.2.4.1.3 "><p id="p187285224457"><a name="p187285224457"></a><a name="p187285224457"></a>redo日志开始指针（LSN），表示redo操作的起始位置。</p>
    </td>
    </tr>
    ...
    <tr id="row151121410311"><td class="cellrowborder" valign="top" width="23.97239723972397%" headers="mcps1.2.4.1.1 "><p id="p111364203015"><a name="p111364203015"></a><a name="p111364203015"></a>write_data_io_counter</p>
    </td>
...
- gs\_xlogdump\_parsepage\_tablepath\(path text, blocknum bigint, relation\_type text, read\_memory boolean\)
  ...
  **表 13**  gs\_xlogdump\_parsepage\_tablepath参数说明
...
- gs\_index\_verify\(Oid oid, uint32:wq blkno\)
  ...
  **表 14**  gs\_index\_verify参数说明
  ...
  <tr id="row44968519215"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p12738153011818"><a name="p12738153011818"></a><a name="p12738153011818"></a>ptype</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p1947519492820"><a name="p1947519492820"></a><a name="p1947519492820"></a>text</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p1947519496987"><a name="p1947519496987"></a><a name="p1947519496987"></a>页面类型（Page Type）。表示索引页的类型。</p>
  </td>
  </tr>
  <tr id="row44968519216"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p12738153011819"><a name="p12738153011819"></a><a name="p12738153011819"></a>status</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p1947519492821"><a name="p1947519492821"></a><a name="p1947519492821"></a>text</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p1947519496988"><a name="p1947519496988"></a><a name="p1947519496988"></a>表示索引页的状态。</p>
  </td>
  </tr>  
  </tbody>
  </table>
...
- gs\_index\_recycle\_queue\(Oid oid, int type, uint32 blkno\)
  ...
  **表 15**  gs\_index\_recycle\_queue参数说明
  ...
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><a name="ul18118153014128"></a><a name="ul18118153014128"></a><ul id="ul18118153014128"><li>回收队列页面编号，该参数只有在type=2的时候有效，blkno有效取值范围为1~4294967294。</li></ul>
    ...
    <tr id="row111793051218"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001212"><a name="p3117203001212"></a><a name="p3117203001212"></a>rblkno</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051219"><a name="p13117163051219"></a><a name="p13117163051219"></a>oid</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id = "p3117203001213"><a name="p3117203001213"></a><a name="p3117203001213"></a>回收块编号。</p>
  </td>
  </tr>
  <tr id="row111793051219"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001214"><a name="p3117203001214"></a><a name="p3117203001214"></a>item_offset</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051220"><a name="p13117163051220"></a><a name="p13117163051220"></a>uint32</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p13117163051221"><a name="p13117163051221"></a><a name="p13117163051221"></a>item的偏移量。</p>
  </td>
  </tr>
  <tr id="row111793051220"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001215"><a name="p3117203001215"></a><a name="p3117203001215"></a>xid</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051221"><a name="p13117163051221"></a><a name="p13117163051221"></a>text</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p13117163051222"><a name="p13117163051222"></a><a name="p13117163051222"></a>事物ID。</p>
  </td>
  </tr>
  <tr id="row111793051221"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001216"><a name="p3117203001216"></a><a name="p3117203001216"></a>dblkno</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051222"><a name="p13117163051222"></a><a name="p13117163051222"></a>oid</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p13117163051223"><a name="p13117163051223"></a><a name="p13117163051223"></a>数据块的编号。</p>
  </td>
  </tr>
  <tr id="row111793051222"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001217"><a name="p3117203001217"></a><a name="p3117203001217"></a>prev</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051223"><a name="p13117163051223"></a><a name="p13117163051223"></a>oid</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p13117163051224"><a name="p13117163051224"></a><a name="p13117163051224"></a>前驱编号。</p>
  </td>
  </tr>
  <tr id="row111793051223"><td class="cellrowborder" valign="top" width="20.242024202420243%" headers="mcps1.2.4.1.1 "><p id="p3117203001218"><a name="p3117203001218"></a><a name="p3117203001218"></a>next</p>
  </td>
  <td class="cellrowborder" valign="top" width="15.48154815481548%" headers="mcps1.2.4.1.2 "><p id="p13117163051225"><a name="p13117163051225"></a><a name="p13117163051225"></a>oid</p>
  </td>
  <td class="cellrowborder" valign="top" width="64.27642764276428%" headers="mcps1.2.4.1.3 "><p id="p13117163051226"><a name="p13117163051226"></a><a name="p13117163051226"></a>后继编号。</p>
  </td>
  </tr>
  </tbody>
  </table>
...
- gs\_stat\_wal\_entrytable\(int64 idx\)
  ...
  **表 16**  gs\_stat\_wal\_entrytable参数说明
...
- gs\_walwriter\_flush\_position\(\)
  ...
  **表 17**  gs\_walwriter\_flush\_position参数说明
...
- gs\_walwriter\_flush\_stat\(int operation\)
  ...
  **表 18**  gs\_walwriter\_flush\_stat参数说明
...
- generate_procoverage_report<a name="section14683125861213"></a>
  ...
  描述：生成postgres库[coverage.proc_coverage](../sql_reference/coverage_proc_coverage.md)表中两个覆盖率序号间存储过程的覆盖率报告，需要在postgres库下执行，且打开enable_proc_coverage参数。
  ...
  >[!NOTE]说明
  >
  > 1. 当begin_id和end_id符合取值范围时，生成二者间（包含）id的所有覆盖率记录的报告。如generate_procoverage_report(2, 5)，若[coverage.proc_coverage](../sql_reference/coverage_proc_coverage.md)表中存在coverage_id为2、3、4、5的报告，将生成2、3、4、5记录的覆盖率报告；若仅存在coverage_id为3、4的报告，将生成3、4记录的覆盖率报告。
...
- query_parameterization_views()
  ...
  | 5              | param_nums          | smallint       | 参数个数                                |
  | 6              | parameterized_query | text           | 被参数化后的SQL语句                      |
