...
WDR Snapshot启动（即参数[enable\_wdr\_snapshot](../database_reference/system_performance_snapshot.md#zh-cn_topic_0283137284_zh-cn_topic_0237124757_section983311682019)为on时），且快照数量大于等于2。
...
6. 在/home/om/下根据需要[查看WDR报告](view_the_wdr_report.md)。
