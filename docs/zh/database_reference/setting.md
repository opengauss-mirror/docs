...
>[!NOTE]说明
>
>如果使用om安装或其他需要使用xml设置集群信息的安装方式，该参数的值依赖xml文件里的dataNode1_syncNum或syncNode_hostname字段的值，具体请参考[创建XML配置文件](../installation_guide/creating_an_xml_configuration_file.md)
...
该参数属于POSTMASTER类型参数，请参考[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t290c8f15953843db8d8e53d867cd893d)中对应设置方法进行设置。
...
该参数属于SIGHUP类型参数，请参考[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t290c8f15953843db8d8e53d867cd893d)中对应设置方法进行设置。
