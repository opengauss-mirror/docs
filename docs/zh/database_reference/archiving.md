...
>[!TIP]须知 
>当[wal\_level](settings.md#zh-cn_topic_0283137354_zh-cn_topic_0237124707_zh-cn_topic_0059778393_s2c76f5957066407a959191148f2c780f)设置成minimal时，archive\_mode参数无法使用。
...
>    ```
>
>- 其中命令限制详情可以参考[dsscmd](../tool_and_commandreference/dsscmd.md)
>
