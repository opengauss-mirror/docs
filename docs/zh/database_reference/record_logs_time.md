...
>[!TIP]须知  
>当此选项与[log\_statement](record_logs_content.md#zh-cn_topic_0237124723_zh-cn_topic_0059778400_s77b3e2e16a3e4705a139bef98688be8a)同时使用时，已经被log\_statement记录的语句文本不会被重复记录。在没有使用syslog情况下，推荐使用[log\_line\_prefix](record_logs_content.md#zh-cn_topic_0237124723_zh-cn_topic_0059778400_sd57ce2167a8149239e10ab0cef12b949)记录PID或会话ID，方便将当前语句消息连接到最后的持续时间消息。  
