...
- 只有当日志的级别为log及以上时，debug\_print\_parse、debug\_print\_rewritten和debug\_print\_plan的调试信息才会输出。当这些选项打开时，调试信息只会记录在服务器的日志中，而不会输出到客户端的日志中。通过设置[client\_min\_messages](record_logs_time.md#zh-cn_topic_0237124722_zh-cn_topic_0059778452_s2955da1f1cb24b0aa68ddc77700233e0)和[log\_min\_messages](record_logs_time.md#zh-cn_topic_0237124722_zh-cn_topic_0059778452_sc6c47ec8cc1b47e28be98dbb24b1b39a)参数可以改变日志级别。 
...
- 设置为off，该选项与[log\_min\_duration\_statement](record_logs_time.md#zh-cn_topic_0237124722_zh-cn_topic_0059778452_s62cf0fb833324a82a841f02134a932e5)的不同之处在于log\_min\_duration\_statement强制记录查询文本。
...
**参数说明**： 当一个会话的等待获得一个锁的时间超过[deadlock\_timeout](lock_management.md#zh-cn_topic_0237124735_zh-cn_topic_0059778102_se697b4ff00b643938b67eb5e08206cd5)的值时，此选项控制在数据库日志中记录此消息。这对于决定锁等待是否会产生一个坏的行为是非常有用的。
