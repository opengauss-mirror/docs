...
- 设置为off，该选项与[log\_min\_duration\_statement](logging_time.md#zh-cn_topic_0237124722_zh-cn_topic_0059778452_s62cf0fb833324a82a841f02134a932e5)的不同之处在于log\_min\_duration\_statement强制记录查询文本。
