...
该系统表仅包含运行[CREATE SUBSCRIPTION](../sql_reference/create_subscription.md)或[ALTER SUBSCRIPTION ... REFRESH PUBLICATION](../sql_reference/alter_subscription.md)后对订阅已知的表。
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p114016229518"><a name="p114016229518"></a><a name="p114016229518"></a>订阅状态。<li>i：初始化</li><li>d：基础数据正在复制</li><li>f：基础数据复制完成</li><li>s：已与增量复制进度同步</li><li>r：准备好增量复制</li></p>
</td>
</tr>
