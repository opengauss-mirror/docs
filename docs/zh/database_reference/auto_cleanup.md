...
**参数说明**： 控制数据库自动清理线程（autovacuum）的启动。自动清理线程运行的前提是将[track\_counts](query_and_index_statistics_collector.md#zh-cn_topic_0283136895_zh-cn_topic_0237124727_zh-cn_topic_0059779313_s3f4fb0b1004041f69e1454c701952411)设置为on。
