...
>[!TIP]须知 
>
>- 如果此参数设置为on，[wal\_level](setting.md#zh-cn_topic_0283137354_zh-cn_topic_0237124707_zh-cn_topic_0059778393_s2c76f5957066407a959191148f2c780f)必须设置为hot\_standby，否则将导致数据库无法启动。
...
> - 当开启极致RTO功能后（配置参数[recovery\_parse\_workers](log_playback.md#zh-cn_topic_0283136722_section2094717549015)和[recovery\_redo\_workers](log_playback.md#zh-cn_topic_0283136722_section81797152110)），备机查询不支持列存表、段页式表。
...
该参数属于SIGHUP类型参数，请参见[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
...
该参数属于POSTMASTER类型参数，请参见[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
