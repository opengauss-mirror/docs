...
> - 当开启极致RTO功能后（配置参数[recovery\_parse\_workers](log_replay.md#zh-cn_topic_0283136722_section2094717549015)和[recovery\_redo\_workers](log_replay.md#zh-cn_topic_0283136722_section81797152110)），备机查询不支持列存表、段页式表。
