...
安装一主一备openGauss资源池化环境。参考[资源池化OM安装部署](./resource_pooling_om_installation_and_deployment.md)。
...
- 在主机侧创建数据库tpcc及用户tpcc。
    ...
    tpcc=# CREATE USER tpcc WITH PASSWORD "xxxxxx";
    CREATE ROLE
...
<table>
    ...
    <tr>
        <th>主机</th><th>备机</th><th>主机</th><th>备机</th><th>主机（tpmC）</th><th>备机（tpmTOTAL）</th>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <th>主机</th><th>备机</th><th>主机</th><th>备机</th><th>主机（TPS）</th><th>备机（TPS）</th>
    </tr>
    <tr>
