...
- 操作步骤
    ...
    在[《文档->安装指南->企业版安装->安装openGauss->创建XML配置文件->配置数据库名称及各项目录》](../installation_guide/creating_an_xml_configuration_file.md)中有配置说明。
    ...
    执行[《文档->安装指南->企业版安装->安装openGauss->初始化安装环境》](../installation_guide/creating_an_xml_configuration_file.md)中的步骤。
