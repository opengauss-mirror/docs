...
- 账本数据库归档功能目前提供两种校验接口，分别为：[ledger\_hist\_archive\(text...](../sql_reference/data_type_used_by_the_ledger_database.md)和[ledger\_gchain\_archive\(vo...](../sql_reference/data_type_used_by_the_ledger_database.md)。账本数据库接口仅审计管理员可以调用。
