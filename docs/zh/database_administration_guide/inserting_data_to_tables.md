...
在创建一个表后，表中并没有数据，在使用这个表之前，需要向表中插入数据。本小节介绍如何使用[INSERT](../sql_reference/insert.md)命令插入一行或多行数据，及从指定表插入数据。如果有大量数据需要批量导入表中，请参考[导入数据](../database_om_guide/import_data.md)。
...
<th class="cellrowborder" valign="top" width="34.839999999999996%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0237120300_zh-cn_topic_0059779039_ac050a387f69f4c02b774c72a219282e2"><a name="zh-cn_topic_0237120300_zh-cn_topic_0059779039_ac050a387f69f4c02b774c72a219282e2"></a><a name="zh-cn_topic_0237120300_zh-cn_topic_0059779039_ac050a387f69f4c02b774c72a219282e2"></a><b>服务端和客户端编码不一致</b></p>
</th>
</tr>
</thead>
...
>[!NOTE]说明  
>数据库[DBCOMPATIBILITY](../sql_reference/create_database.md)设为兼容TD模式，且[td\_compatible\_truncation](../database_reference/platform_and_client_compatibility.md#zh-cn_topic_0283137001_zh-cn_topic_0237124738_zh-cn_topic_0059779195_sb8212ce57eb9432a972e390f77203b7c)参数设置为on的情况下，才会对超长字符串进行截断。  
...
<th class="cellrowborder" valign="top" width="22.882288228822883%" id="mcps1.2.8.1.5"><p id="zh-cn_topic_0237120300_zh-cn_topic_0059779039_a9186930615fc4a6282dc148a108b1911"><a name="zh-cn_topic_0237120300_zh-cn_topic_0059779039_a9186930615fc4a6282dc148a108b1911"></a><a name="zh-cn_topic_0237120300_zh-cn_topic_0059779039_a9186930615fc4a6282dc148a108b1911"></a>示例</p>
</th>
