...
- **enable\_group\_commit = false**
    ...
    有关WAL重做日志的详细信息，请参阅[MOT日志记录：WAL重做日志](mot_durability_concepts.md)。
...
- **group\_commit\_timeout = 10 ms**
    ...
    >[!NOTE]说明
    有关同步组提交日志记录的详细信息，请参阅[MOT日志类型](mot_durability.md#section125771537134)。
...
>[!NOTE]说明
>有关配置的更多信息，请参阅[MOT检查点](mot_durability_concepts.md)。
