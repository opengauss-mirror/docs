...
3. 创建客户端主密钥CMK和列加密密钥CEK。创建CMK的语法请参考[CREATE CLIENT MASTER KEY](../sql_reference/create_client_master_key.md)、创建的CEK的语法请参考[CREATE COLUMN ENCRYPTION KEY](../sql_reference/create_column_encryption_key.md)。
