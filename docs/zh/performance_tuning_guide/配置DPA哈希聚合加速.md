...
1. **平台限制**：DPA功能仅在ARM64架构平台上可用，x86架构无法使用该功能。详情参考[平台限制](https://opengauss.org/zh/docs/2.0.0/docs/Developer-Guide-2.0.0/%E5%AE%89%E8)
...
该参数属于POSTMASTER类型参数，修改后需要重启数据库生效。请参考[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
