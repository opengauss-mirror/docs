...
- 高性能：Xlog刷盘优化
  ...
  - 新增添加[enable_LC_xlog_flush_optimize](../database_reference/other_options.md#enable_lc_xlog_flush_optimize)和xlog_write_flush_split参数，通过在低并发场景直接刷xlog、部分字段合并、减少持锁放锁代价等方式提升低并发场景下的xlog刷盘效率。[其他选项](../database_reference/other_options.md)
