...
additional_args = ['--enable-local-file-access','--zoom','1.2','--user-style-sheet','_static/my_theme.css','--footer-center','2023, openGauss','--footer-font-size','8','--footer-font-name','Aria','toc','--toc-header-text','目录']
