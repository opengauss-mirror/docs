...
- Standard SQL
  ...
  openGauss supports most of the SQL:2011 core features and some optional features. For details about the feature list, see [SQL Syntax](../sql_reference/sql-syntax.md).
