...
<td class="cellrowborder" valign="top" width="29.8029802980298%" headers="mcps1.2.4.1.3 "><p id="p8811910113812"><a name="p8811910113812"></a><a name="p8811910113812"></a>For the same SP version, if the kernel minor versions are inconsistent or an incompatibility error is reported during kernel component installation, you need to modify the OS <strong id="b201821433204314"><a name="b201821433204314"></a><a name="b201821433204314"></a>weak-modules</strong> script. For details, refer to <a id="i242714361010"></a><a href="https://opengauss.org/en/blogs/weak-modules/Modification_of_the_weak-modules_Script_for_OS_Compatibility.html" target="_blank" rel="noopener noreferrer">Modification of the weak-modules Script for OS Compatibility</a>.</p>
</td>
</tr>
