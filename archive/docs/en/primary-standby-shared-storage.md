...
-   Prerequisites
    -   The code of the project has been compiled. For details about the compilation, see [Software Compilation and Installation](../../compilation_guide/setting_up_the_compilation_environment.md).
