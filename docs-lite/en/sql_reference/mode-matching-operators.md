...
- SIMILAR TO
    ...
    The  [**substring\(string from pa...**](character-processing-functions-and-operators.md)  function extracts a substring that matches an SQL regular expression pattern.
...
- POSIX regular expressions
    ...
    **Table  1**  Regular expression match operators
    ...
    - The  [**substring\(string from pa...**](character-processing-functions-and-operators.md)  function provides a method for extracting a substring that matches the POSIX regular expression pattern.
    - The  **[•regexp\_count\(string tex...](character-processing-functions-and-operators.md)**  function counts the number of substrings that match the POSIX regular expression pattern.
    - The  **[•regexp\_instr\(string tex...](character-processing-functions-and-operators.md)**  function obtains the position of a substring that matches the POSIX regular expression pattern.
    - The  **[•regexp\_substr\(string te...](character-processing-functions-and-operators.md)**  function extracts a substring that matches the POSIX regular expression pattern.
    - The  [**regexp\_replace\(string, p...**](character-processing-functions-and-operators.md)  function replaces a substring that matches the POSIX regular expression pattern with the new text.
    - The  [**regexp\_matches\(string te...**](character-processing-functions-and-operators.md)  function returns a text array consisting of all captured substrings that match a POSIX regular expression pattern.
    - The  [**regexp\_split\_to\_table\(st...**](character-processing-functions-and-operators.md)  function splits a string using a POSIX regular expression pattern as a delimiter.
    - The  [**regexp\_split\_to\_array\(st...**](character-processing-functions-and-operators.md)  function behaves the same as  **regexp\_split\_to\_table**, except that it returns its result as an array of text.
