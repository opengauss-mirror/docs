...
- numtodsinterval\(num, interval\_unit\)
    ...
    You can set the  [IntervalStyle](../database_reference/locale_and_formatting.md#en-us_topic_0283136798_en-us_topic_0237124733_en-us_topic_0059778109_s89302a8dcd7f46ecb7167574d6397dc0)  parameter to  **a**  to be compatible with the interval output format of the function.
