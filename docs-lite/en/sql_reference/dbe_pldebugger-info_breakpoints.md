# DBE\_PLDEBUGGER.info\_breakpoints<a name="EN-US_TOPIC_0000001162605977"></a>

During debugging on the debug end, call  **info\_breakpoints**  to view the current function breakpoint.

**Table  1**  info\_breakpoints input parameters and return values
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p0748851184315"><a name="p0748851184315"></a><a name="p0748851184315"></a>Breakpoint number</p>
</td>
</tr>
