...
- **OPTIONS**
    ...
    - The options supported by postgres\_fdw are the same as those supported by libpq. For details, see  [Link Parameters](../developer_guide/link_parameters_libpq.md). Note that the following options cannot be modified:
        - **user**  and  **password**
