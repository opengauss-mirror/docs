...
<td class="cellrowborder" valign="top" width="49.05509449055094%" headers="mcps1.2.5.1.3 "><p id="p43971231315"><a name="p43971231315"></a><a name="p43971231315"></a>List of statement lock events, which are recorded in chronological order. The number of records is affected by the <strong id="b1776392919558"><a name="b1776392919558"></a><a name="b1776392919558"></a>track_stmt_details_size</strong> parameter. This column is binary and needs to be read using the parsing function <strong id="b1476916297551"><a name="b1476916297551"></a><a name="b1476916297551"></a>pg_catalog.statement_detail_decode</strong>. For details, see <a href="../sql_reference/other-functions.md#table9745177191215">Table 6</a>.</p>
...
<a name="ul21561963304"></a><a name="ul21561963304"></a><ul id="ul21561963304"><li><strong id="b119307543013"><a name="b119307543013"></a><a name="b119307543013"></a>t</strong> (true): yes</li><li><strong id="b4101165617017"><a name="b4101165617017"></a><a name="b4101165617017"></a>f</strong> (false): no</li></ul>
</td>
