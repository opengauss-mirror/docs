...
**Parameter description:**  Specifies whether to skip errors and continue compiling PLPGSQL objects. For details about the impact, see  [DBE\_PLDEVELOPER](../sql_reference/dbe_pldeveloper.md).
