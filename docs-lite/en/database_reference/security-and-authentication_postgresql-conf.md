...
This parameter is of the USERSET type and can be set only using the  [SET SESSION AUTHORIZATION](../sql_reference/set-session-authorization.md)  syntax.
...
**Parameter description**: Specifies whether SSL connections are enabled. Read  [Using gsql to Connect to a Database](../getting_started/gsql_connection_and_usage.md)  before setting this parameter.
