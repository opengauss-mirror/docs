...
3. Run the **install.sh** script to install the openGauss Lite installation package.
   ...
   >   Procedure
   >   
   >   -   Prepare certificates and private keys. For details about how to generate a certificate, see [Generating Certificates](../database_administration_guide/ssl_certificate_management.md).
