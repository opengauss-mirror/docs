# Exporting a Single Database<a name="EN-US_TOPIC_0289900499"></a>
...
2. Run  **gs\_dump**  to export the  **hr**  and  **public**  schemas.
    ...
    **Table  1**  Common parameters
    ...
    <td class="cellrowborder" valign="top" width="44.16%" headers="mcps1.2.4.1.2 "><p id="en-us_topic_0283136726_en-us_topic_0237121170_p1278211752814"><a name="en-us_topic_0283136726_en-us_topic_0237121170_p1278211752814"></a><a name="en-us_topic_0283136726_en-us_topic_0237121170_p1278211752814"></a>Name of the database to be exported.</p>
    </td>
...
Example 1: Run  **gs\_dump**  to export full information of the  **hr**  schema. The exported file is in text format.
...
Example 5: Run  **gs\_dump**  to export the definitions of both the  **hr**  and  **public**  schemas. The exported file is in .tar format.
