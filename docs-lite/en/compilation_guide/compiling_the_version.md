...
- The software and hardware have been prepared based on the requirements in  [Setting up the Build Environment](setting_up_the_build_environment.md), and the code has been downloaded by referring to  [Downloading Code](#en-us_topic_0283136302_section188203481850).
- Open-source software has been built. For details, see  [Building Open-source Software](#en-us_topic_0283136302_section13890105116714).
