...
- The software and hardware have been prepared based on the requirements in  [Setting up the Build Environment](setting_up_the_build_environment.md), and the code has been downloaded by referring to  [Downloading Code](preparations.md#en-us_topic_0283136302_section188203481850).
