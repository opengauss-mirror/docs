...
For example, the **[MOT Engine](../database_administration_guide/mot_introduction.md)** section provides a detailed review of the Memory Optimized Tables, a high performance storage engine embedded side-by-side the standard storage engine. This includes "MOT Introduction" section (including performance benchmarks), followed by the "Using MOT" section complete manual guide, and concluded by the "MOT Concepts" section with deeper insight into MOT design and technologies.
