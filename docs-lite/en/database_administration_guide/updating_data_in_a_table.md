# Updating Data in a Table<a name="EN-US_TOPIC_0289900576"></a>
...
For details about how to create a table and insert data to it, see  [Creating Tables](creating_tables.md)  and  [Inserting Data to Tables](inserting_data_to_tables.md).
