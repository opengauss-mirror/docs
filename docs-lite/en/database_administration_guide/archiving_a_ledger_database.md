...
- Currently, the ledger database provides two archiving interfaces:  [ledger\_hist\_archive\(text...](../sql_reference/ledger-database-functions.md)  and  [ledger\_gchain\_archive\(vo...](../sql_reference/ledger-database-functions.md. Only the audit administrator can invoke the ledger database interfaces.
