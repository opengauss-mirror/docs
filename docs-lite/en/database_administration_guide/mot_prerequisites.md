# MOT Prerequisites<a name="EN-US_TOPIC_0289901003"></a>

The following specifies the hardware and software prerequisites for using openGauss MOT.

## Supported Hardware<a name="en-us_topic_0283136672_en-us_topic_0270171545_section2795111724213"></a>
...
## CPU<a name="en-us_topic_0283136672_en-us_topic_0270171545_section35486275421"></a>
...
## Memory<a name="en-us_topic_0283136672_en-us_topic_0270171545_section1294374584217"></a>

MOT supports standard RAM/DRAM for its data and transaction management. All MOT tables’ data and indexes reside in-memory; therefore, the memory capacity must support the data capacity and still have space for further growth. For detailed information about memory requirements and planning, see the  [MOT Memory and Storage Planning](mot_memory_and_storage_planning.md)__section.

## Storage IO<a name="en-us_topic_0283136672_en-us_topic_0270171545_section8264125484218"></a>
...
For detailed memory requirements and planning, see the  [MOT Memory and Storage Planning](mot_memory_and_storage_planning.md)__section_._
