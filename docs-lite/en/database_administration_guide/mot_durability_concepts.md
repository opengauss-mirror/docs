...
You may refer to  [MOT Key Technologies](mot_key_technologies.md)  sectionfor an overview of how durability is implemented in the MOT engine.
...
- **Synchronous Redo Logging**
    ...
    **Figure  1**  Synchronous Logging<a name="en-us_topic_0283136556_en-us_topic_0280525164_fig25836861"></a>  
    ![](figures/synchronous-logging.png)
...
- **Group Synchronous Redo Logging**
    ...
    3. After the configured criteria are fulfilled for a specific group of transactions \(quantity of committed transactions or timeout period as describes in the  [Redo Log \(MOT\)](mot_configuration.md#en-us_topic_0283136588_en-us_topic_0280525130_section361563811235)  section\), the transactions in this group are written to the WAL on the disk. This means that while these log entries are being written to the log, the client applications that issued the commit are waiting for a response.
    ...
    **Figure  2**  Group Commit – with NUMA-awareness<a name="en-us_topic_0283136556_en-us_topic_0280525164_fig34015509"></a>  
    ![](figures/group-commit-with-numa-awareness.png)
...
- **Asynchronous Redo Logging**
    ...
    **Figure  3**  Asynchronous Logging<a name="en-us_topic_0283136556_en-us_topic_0280525164_fig44824869"></a>  
    ![](figures/asynchronous-logging.png)
    ...
    **Figure  4**  Three Logging Options<a name="en-us_topic_0283136556_en-us_topic_0280525164_fig48696192"></a>  
    ![](figures/three-logging-options.png)
...
![](figures/per-transaction-logging.png)
...
Low-overhead asynchronous checkpointing in main-memory database systems<sup>\[</sup>[Comparison: Disk vs. MOT](comparison_disk_vs_mot.md)<sup>\]</sup>.
...
Checkpoint configuration is performed in the mot.conf file – see the  [Checkpoint \(MOT\)](mot_configuration.md#en-us_topic_0283136588_en-us_topic_0280525130_section8719101152712)  section.
