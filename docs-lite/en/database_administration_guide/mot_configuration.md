...
-   **enable\_redo\_log = true**
    ...
    Specifies whether to use the Redo Log for durability. See  [MOT Logging – WAL Redo Log](mot_durability.md#en-us_topic_0283136668_en-us_topic_0280525142_section129831140121218)  for more information about redo logs.
...
-   **enable\_group\_commit = false**
    ...
    You may refer to  [MOT Logging – WAL Redo Log](mot_durability.md#en-us_topic_0283136668_en-us_topic_0280525142_section129831140121218)  for more information about the WAL Redo Log.
...
-   **group\_commit\_timeout = 10 ms**
    ...
    You may refer to the  [MOT Logging Types](mot_durability.md#en-us_topic_0283136668_en-us_topic_0280525142_section125771537134)  section for more information about synchronous group commit logging.
