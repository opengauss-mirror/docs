...
- When an exception occurs or a global blockchain table or user history table is damaged, you can use the  [ledger\_gchain\_repair\(tex...](../sql_reference/ledger-database-functions.md)  or  [ledger\_hist\_repair\(text,...](../sql_reference/ledger-database-functions.md)  interface to repair the table. After the fault is rectified, the result of invoking the global blockchain table or user history table verification interface is  **true**.
