# Parameter Tuning and Diagnosis<a name="EN-US_TOPIC_0000001151995073"></a>
...
- If you log in to the database host as a Linux user, add  _$GAUSSHOME_**/bin**  to the  _PATH_environment variable so that you can directly run database O&M tools, such as gsql, gs\_guc, and gs\_ctl.
