...
- 镜像获取
详见[openGauss容器安装部署](../installation_guide/installing_the_container_image.md)。
- 容器启动
启动命令：
...
IVFFLAT-NPU特性相关GUC参数详情请参见[DataVec向量引擎参数](../database_reference/datavec_vector_engine_parameters.md)。
