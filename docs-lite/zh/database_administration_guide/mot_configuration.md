# MOT配置<a name="ZH-CN_TOPIC_0289899989"></a>
...
阅读[总体原则](#zh-cn_topic_0283136588_zh-cn_topic_0280525130_section14452102715206)，根据需要查看和配置mot.conf文件。

>[!NOTE]说明
>
>以上描述了mot.conf文件中的各个设置。除上述内容外，要了解特定MOT功能（如恢复），可参考本用户手册的相关章节。例如，[MOT恢复](mot_recovery.md)说明了mot.conf文件的恢复，包含影响MOT恢复的设置。此外，有关恢复的完整说明，请参阅“MOT管理”章节的[MOT恢复](mot_recovery.md)。下文各相关章节中还提供了参考链接。

以下介绍了mot.conf文件中的各个部分，其包含的设置以及默认值。

## 总体原则<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section14452102715206"></a>
...
## 重做日志（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section361563811235"></a>

- **enable\_redo\_log = true**

    指定是否使用重做日志以获得持久性。有关重做日志的详细信息，请参阅[MOT日志记录：WAL重做日志](mot_durability.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section129831140121218)。
...
- **enable\_group\_commit = false**
    ...
    有关WAL重做日志的详细信息，请参阅[MOT日志记录：WAL重做日志](mot_durability.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section129831140121218)。
...
- **group\_commit\_timeout = 10 ms**
    ...
    有关同步组提交日志记录的详细信息，请参阅[MOT日志类型](mot_durability.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section125771537134)。

## 检查点（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section8719101152712"></a>
...
>[!NOTE]说明
>
>有关配置的更多信息，请参阅[MOT检查点](mot_durability.md#zh-cn_topic_0283136668_zh-cn_topic_0280525142_section182761535131617)。

## 恢复（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section7442447103115"></a>
...
>[!NOTE]说明
>
>有关配置的详细信息，请参阅[MOT恢复](mot_recovery.md)。

## 统计（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section659861612477"></a>
...
## 错误日志（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section28451692"></a>
...
## 内存（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section1223551495"></a>
...
## 垃圾收集（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section22885696"></a>
...
## JIT（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section4644675"></a>
...
## 存储（MOT）<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section16572933681"></a>

**allow\_index\_on\_nullable\_column = true**

指定是否允许在可空列上定义索引。

## 默认MOT.conf文件<a name="zh-cn_topic_0283136588_zh-cn_topic_0280525130_section40674409"></a>
