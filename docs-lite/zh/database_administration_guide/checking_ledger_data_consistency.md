# 校验账本数据一致性<a name="ZH-CN_TOPIC_0000001147007425"></a>
...
- 账本数据库校验功能目前提供两种校验接口，分别为：[ledger\_hist\_check\(text,...](../sql_reference/ledger_database_functions.md)和[ledger\_gchain\_check\(text...](../sql_reference/ledger_database_functions.md)。普通用户调用校验接口，仅能校验自己有权限访问的表。
