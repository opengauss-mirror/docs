# 使用DML命令更新表<a name="ZH-CN_TOPIC_0289900189"></a>

openGauss支持标准的数据库操作语言（DML）命令，对表进行更新。

## 操作步骤<a name="zh-cn_topic_0283136592_zh-cn_topic_0237121139_zh-cn_topic_0165787111_section6970183123711"></a>
...
- 使用INSERT向表中插入数据。
    ...
    - 向表customer\_t中插入多行数据。
        ...
        更多关于INSERT的使用方法，请参见[向表中插入数据](../database_administration_guide/inserting_data_to_tables.md)。
...
- 使用UPDATE更新表中数据。修改字段c\_customer\_id值为0。
    ...
    更多关于UPDATE的使用方法，请参见[UPDATE](../sql_reference/UPDATE.md)。
...
- 使用DELETE删除表中的行。
    ...
    更多关于DELETE的使用方法，请参见[DELETE](../sql_reference/DELETE.md)。
...
- 使用TRUNCATE命令快速从表中删除所有的行。
    ...
    更多关于TRUNCATE的使用方法，请参见[TRUNCATE](../sql_reference/TRUNCATE.md)。
