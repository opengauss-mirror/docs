...
openGauss提供了GUC参数[autovacuum](../database_reference/auto_cleanup.md#zh-cn_topic_0283137694_zh-cn_topic_0237124730_zh-cn_topic_0059778244_s995913ca9df54ae5bb488d1e810bd824)用于控制数据库自动清理功能的启动。
...
- [autovacuum\_max\_workers](../database_reference/auto_cleanup.md)参数需要大于0，该参数表示能同时运行的自动清理线程的最大数量。
- [autovacuum\_mode](../database_reference/auto_cleanup.md)参需要配置允许进行analyze。
