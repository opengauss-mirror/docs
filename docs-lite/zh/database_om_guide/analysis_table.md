...
ANALYZE支持的表类型有行/列存表。ANALYZE同时也支持对本地表的指定列进行信息统计。下面以表的ANALYZE为例，更多关于ANALYZE的信息，请参见[ANALYZE | ANALYSE](../sql_reference/analyze_analyse.md)。
...
openGauss提供了GUC参数[autovacuum](../database_reference/automatic_vacuuming.md#zh-cn_topic_0283137694_zh-cn_topic_0237124730_zh-cn_topic_0059778244_s995913ca9df54ae5bb488d1e810bd824)用于控制数据库自动清理功能的启动。
...
- [autovacuum\_max\_workers](../database_reference/automatic_vacuuming.md)参数需要大于0，该参数表示能同时运行的自动清理线程的最大数量。
- [autovacuum\_mode](../database_reference/automatic_vacuuming.md)参需要配置允许进行analyze。
