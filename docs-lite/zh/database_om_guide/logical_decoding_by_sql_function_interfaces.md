...
- 设置GUC参数[wal\_level](../database_reference/setting.md#zh-cn_topic_0283137354_zh-cn_topic_0237124707_zh-cn_topic_0059778393_s2c76f5957066407a959191148f2c780f)=logical。
- 设置GUC参数[max\_replication\_slots](../database_reference/send_server.md#zh-cn_topic_0283137693_section7322161612568)\>=每个节点所需的（物理流复制槽数+逻辑复制槽数）。
