...
- 逻辑日志目前从主机节点中抽取，如果进行逻辑复制，需要保证GUC参数[ssl](../database_reference/security_and_authentication_postgresql_conf.md#zh-cn_topic_0283137371_zh-cn_topic_0237124696_zh-cn_topic_0059778664_s8c4647db116f44c4b9ce3dceee3d6ffa)=on。

    >[!NOTE]说明
    >
    >为避免安全风险，请保证启用SSL连接。

- 设置GUC参数[wal\_level](../database_reference/settings.md#zh-cn_topic_0283137354_zh-cn_topic_0237124707_zh-cn_topic_0059778393_s2c76f5957066407a959191148f2c780f)=logical。
- 设置GUC参数[max\_replication\_slots](../database_reference/sending_server.md#zh-cn_topic_0283137693_section7322161612568)\>=每个节点所需的（物理流复制槽数+逻辑复制槽数）。
