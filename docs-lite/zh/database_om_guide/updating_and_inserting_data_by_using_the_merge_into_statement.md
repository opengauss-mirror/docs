# 使用合并方式更新和插入数据<a name="ZH-CN_TOPIC_0289899987"></a>
...
3. 使用MERGE INTO 语句将源表products的数据合并至目标表newproducts。
    ...
    上述语句中使用的参数说明，请见[表1](#zh-cn_topic_0283137209_zh-cn_topic_0237121140_zh-cn_topic_0165787112_table1973914406416)。更多信息，请参见[MERGE INTO](../sql_reference/merge_into.md)。
