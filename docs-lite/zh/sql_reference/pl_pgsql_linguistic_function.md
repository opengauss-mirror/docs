# PL/pgSQL语言函数<a name="ZH-CN_TOPIC_0289901009"></a>
...
应用PL/pgSQL创建函数的语法为[CREATE FUNCTION](create_function.md)。PL/pgSQL是一种可载入的过程语言。其应用方法与[存储过程](stored_procedure_20.md)相似，只是存储过程无返回值，函数有返回值。
