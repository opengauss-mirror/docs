...
[CREATE DATABASE](create_database.md)，[CREATE TABLE](create_table.md)，[CREATE INDEX](create_index.md)，[DROP TABLESPACE](drop_tablespace.md)，[ALTER TABLESPACE](alter_tablespace.md)
