# record<a name="ZH-CN_TOPIC_0289899954"></a>

## record类型的变量<a name="zh-cn_topic_0283136936_zh-cn_topic_0237122215_section16992418680"></a>

创建一个record变量的方式：

定义一个record类型 ，然后使用该类型来声明一个变量。

## 语法<a name="zh-cn_topic_0283136936_zh-cn_topic_0237122215_section7403195020496"></a>

record类型的语法参见[图1](#zh-cn_topic_0283136936_zh-cn_topic_0237122215_fig092918316312)。

**图 1**  record类型的语法<a name="zh-cn_topic_0283136936_zh-cn_topic_0237122215_fig092918316312"></a>  
![](figures/record类型的语法.png)
