...
+ **var\_name**
  ...
  >- 当sql\_compatibility = 'B' && b\_format\_behavior\_compat\_options = 'enable\_set\_variables'时，对于数据库原始的@ expr，请参考[数字操作符](mathematical_functions_and_operators.md#zh-cn_topic_0283136987_zh-cn_topic_0237121971_zh-cn_topic_0059777932_s00454841bcf24ad18eed980c0e3a2f75)，@需要与expr有空格，否则会将其解析成用户变量。
  >- 未初始化的变量值为NULL。
