# 模式匹配操作符<a name="ZH-CN_TOPIC_0289900559"></a>
...
- SIMILAR TO
    ...
    支持使用函数[substring\(string from pa...](character_processing_functions_and_operators.md#ZH-CN_TOPIC_0289900656)截取匹配SQL正则表达式的子字符串。
...
- POSIX正则表达式
    ...
    **表 1**  正则表达式匹配操作符
    ...
    - [•regexp\_substr\(string te...](character_processing_functions_and_operators.md函数提供了抽取一个匹配POSIX正则表达式模式的子串的方法。
