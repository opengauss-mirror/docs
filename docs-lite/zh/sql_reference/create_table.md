# 创建表<a name="ZH-CN_TOPIC_0000001255141783"></a>
...
执行如下命令创建一个表，表名为customer\_t1，表字段为c\_customer\_sk 、c\_customer\_id、c\_first\_name、c\_last\_name和Amount，每个表字段对应的数据类型为integer、char\(5\)、char\(6\)、char\(8\)和integer。
