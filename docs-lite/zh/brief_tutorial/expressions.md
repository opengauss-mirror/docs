...
- 逻辑表达式
    ...
    逻辑表达式的操作符和运算规则，详情请参见[逻辑操作符](operators.md#section2075011374558)。

- 比较表达式

    常用的比较操作符，请参见[操作符](../sql_reference/operator.md)。
