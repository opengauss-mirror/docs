...
- 已按照[搭建编译环境](setting_up_the_build_environment.md)的要求准备好相关软硬件，并且已参考[代码下载](preparations.md#zh-cn_topic_0283136302_section188203481850)下载了代码。
- 已完成开源软件编译构建，具体请参见[开源软件编译构建](preparations.md#zh-cn_topic_0283136302_section13890105116714)。
