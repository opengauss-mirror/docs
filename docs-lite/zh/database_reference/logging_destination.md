...
- 取值为stderr，表示日志打印到屏幕。
- 取值为csvlog，表示日志的输出格式为“逗号分隔值”即CSV （Comma Separated Value）格式。使用csvlog记录日志的前提是将[logging\_collector](#zh-cn_topic_0283136719_zh-cn_topic_0237124721_zh-cn_topic_0059778787_s61d6090c04ee464fb54f8b31936ba818)设置为on，请参见[使用CSV格式写日志](using_csv_log_output.md)。
