...
- 设置为off，该选项与[log\_min\_duration\_statement](logging_time.md#zh-cn_topic_0283137528_zh-cn_topic_0237124722_zh-cn_topic_0059778452_s62cf0fb833324a82a841f02134a932e5)的不同之处在于log\_min\_duration\_statement强制记录查询文本。
...
**参数说明**： 设置服务器写日志文件时使用的时区。与[TimeZone](locale_and_formatting.md#zh-cn_topic_0283136798_zh-cn_topic_0237124733_zh-cn_topic_0059778109_sa60c5d71347646c2ad97ccb7541c6f12)不同，这个值是数据库范围的，针对所有连接到本数据库的会话生效。
