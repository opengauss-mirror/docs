...
## skip\_new\_column\_for\_ruledef<a name="zh-cn_topic_0283136680_zh-cn_topic_0237124753_zh-cn_topic_0059778487_s1df9119d74fe45da9452d4cb4802f8d"></a>

**参数说明**： 控制在升级或者回滚的过程中，创建的视图语法树中不含高版本系统表新增的字段。该参数不推荐用户手动修改，由升级回滚脚本自动设置，且仅在IsInplaceUpgrade为on时生效。

该参数属于SUSET类型参数，请参考[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。不允许通过gs_guc设置。
