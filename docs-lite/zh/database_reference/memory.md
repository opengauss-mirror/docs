...
5. 在实际业务环境中，建议设置shared\_buffers值为内存的30%~40%，可以数据量大小、业务压力等实际情况进行调整。推荐如下：
   - 系统总内存100G : 推荐范围30G~40G;
   - 系统总内存512G : 推荐范围150G~200G;
   - 系统总内存1024G: 推荐范围300G~400G;
...
该参数属于PGC\_SIGHUP类型参数，请参考[表1](../database_administration_guide/reset_parameters.md#zh-cn_topic_0283137176_zh-cn_topic_0237121562_zh-cn_topic_0059777490_t91a6f212010f4503b24d7943aed6d846)中对应设置方法进行设置。
