...
RUN cd /src/ && \
    git clone https://gitcode.com/opengauss/docs --depth=1 latest/docs && \
    ...
    git clone -b 1.0.0 https://gitcode.com/opengauss/docs --depth=1 1.0.0/docs && \
    ...
    git clone -b 1.0.1 https://gitcode.com/opengauss/docs --depth=1 1.0.1/docs && \
    ...
    git clone -b 1.1.0 https://gitcode.com/opengauss/docs --depth=1 1.1.0/docs && \
    ...
    git clone -b 2.0.0 https://gitcode.com/opengauss/docs --depth=1 2.0.0/docs && \
    ...
    git clone -b 2.0.1 https://gitcode.com/opengauss/docs --depth=1 2.0.1/docs && \
    ...
    git clone -b 2.1.0 https://gitcode.com/opengauss/docs --depth=1 2.1.0/docs && \
    ...
    git clone -b 3.0.0 https://gitcode.com/opengauss/docs --depth=1 3.0.0/docs && \
    ...
    git clone -b 3.1.0 https://gitcode.com/opengauss/docs --depth=1 3.1.0/docs && \
    ...
    git clone -b 3.1.1 https://gitcode.com/opengauss/docs --depth=1 3.1.1/docs && \
    ...
    git clone -b 5.0.0 https://gitcode.com/opengauss/docs --depth=1 5.0.0/docs && \
    ...
    git clone -b 5.1.0 https://gitcode.com/opengauss/docs --depth=1 5.1.0/docs && \
    ...
    git clone -b 6.0.0-RC1 https://gitcode.com/opengauss/docs --depth=1 6.0.0-RC1/docs && \
    ...
    git clone -b 6.0.0 https://gitcode.com/opengauss/docs 6.0.0/docs && \
    ...
    git clone -b 7.0.0-RC1 https://gitcode.com/opengauss/docs --depth=1 7.0.0-RC1/docs && \
    ...
    cp -rf /src/7.0.0-RC1/docs/content/en/* /src/website/content/en/docs/7.0.0-RC1 && \

    mkdir -p /src/website/content/zh/docs/7.0.0-RC1-lite/ && \
    cp -rf /src/7.0.0-RC1/docs/content/docs-lite/zh/* /src/website/content/zh/docs/7.0.0-RC1-lite/ && \
